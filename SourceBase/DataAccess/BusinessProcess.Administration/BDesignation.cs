...
namespace BusinessProcess.Administration
{
    public class BDesignation : ProcessBase, IDesignation
    {
        ...
        public DataSet GetDesignation()
        {
            lock (this)
            {
                ...
                return (DataSet)DesignationManager.ReturnObject(oUtility.theParams, "pr_Admin_SelectDesignation_Constella", ClsUtility.ObjectEnum.DataSet);
            }
        }
        public DataSet GetDesignationByID(int designationid)
        {
            lock (this)
            {
                ...
                ClsObject DesignationManager = new ClsObject();
                return (DataSet)DesignationManager.ReturnObject(oUtility.theParams, "pr_Admin_SelectDesignationByID_Constella", ClsUtility.ObjectEnum.DataSet);
            }
        }
        ...
        public int SaveNewDesignation(string DesignationName, int UserID,  int Sequence)
        {
            ...
            try
            {
                ...
                oUtility.Init_Hashtable();
                oUtility.AddParameters("@Designation_Name", SqlDbType.VarChar, DesignationName);
  ...
  //              oUtility.AddParameters("@DeleteFlag", SqlDbType.Int, DeleteFlag.ToString());
                ...
                DataRow theDR;
                int RowsAffected = (Int32)DesignationManager.ReturnObject(oUtility.theParams, "Pr_Admin_InsertDesignation_Constella", ClsUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
        ...
        public int UpdateDesignation(int DesignationID, string DesignationName, int UserID, int DeleteFlag, int Sequence)
        {
            ...
            try
            {
                ...
                oUtility.AddParameters("@Designation_Name", SqlDbType.VarChar, DesignationName);
                oUtility.AddParameters("@UserId", SqlDbType.Int, UserID.ToString());
                oUtility.AddParameters("@Designation_ID", SqlDbType.Int, DesignationID.ToString());
                oUtility.AddParameters("@DeleteFlag", SqlDbType.Int, DeleteFlag.ToString());
                oUtility.AddParameters("@Sequence", SqlDbType.Int, Sequence.ToString());

                DataRow theDR;
                int RowsAffected = (Int32)DesignationManager.ReturnObject(oUtility.theParams, "Pr_Admin_UpdateDesignation_Constella", ClsUtility.ObjectEnum.ExecuteNonQuery);
                if (RowsAffected == 0)
                {
                    MsgBuilder theBL = new MsgBuilder();
                    theBL.DataElements["MessageText"] = "Error in Saving Designation record. Try Again..";
        ...
        public void DeleteDesignation(int DesignationID)
        {
            ...
            try
            {
                ...
                {
                    oUtility.Init_Hashtable();
                    oUtility.AddParameters("@Original_Designation_id", SqlDbType.Int, DesignationID.ToString());
                    DesignationManager.ReturnObject(oUtility.theParams, "pr_Admin_DeleteDesignation_Constella", ClsUtility.ObjectEnum.ExecuteNonQuery);
