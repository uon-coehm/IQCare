...
namespace BusinessProcess.Clinical
{
    class BAdultIE : ProcessBase, IKNHAdultIE
    {
        ...
        public DataTable GetKnhAdultIEData(BIQAdultIE adultIEFields)
        {
            ...
            DataTable regDT = (DataTable)GetRecs.ReturnObject(oUtility.theParams, "Pr_Clinical_GetKNHAdultIE", ClsUtility.ObjectEnum.DataTable);
            return regDT;
        }
        public DataTable GetPatientVisitIdAdultIE(int PatientId, int Visittype)
        {
            ...
            ClsObject GetRecs = new ClsObject();
            DataTable regDT = (DataTable)GetRecs.ReturnObject(oUtility.theParams, "Pr_Clinical_GetPatientVisitIdAdultIE", ClsUtility.ObjectEnum.DataTable);
            return regDT;
        }
        ...
        public DataSet GetKnhAdultIEFormData(BIQAdultIE adultIEFields)
        {
            ...
            ClsObject GetRecs = new ClsObject();
            DataSet regDS = (DataSet)GetRecs.ReturnObject(oUtility.theParams, "Pr_Clinical_GetKNHAdultIE", ClsUtility.ObjectEnum.DataSet);
            return regDS;
        }
            ...
            try
            {
                ...
                if (lstadultIEFields.Count > 0)
                {
                    foreach (var adultIEFields in lstadultIEFields)
                    {
                        ...
                        oUtility.AddParameters("@MernarcheDate", SqlDbType.Int, ConverTotValue.NullToInt(adultIEFields.Mernarchedate).ToString());
                        ...
                        theDT = (DataTable)expressManagerTest.ReturnObject(oUtility.theParams, "Pr_Clinical_AddAdultIE", ClsUtility.ObjectEnum.DataTable);
                        ...
                        theRowAffected = (int)expressManagerTest.ReturnObject(oUtility.theParams, "pr_Clinical_SaveCustomForm_Constella", ClsUtility.ObjectEnum.ExecuteNonQuery); 
                    }
                }
            ...
            try
            {
                ...
                if (lstadultIEFields.Count > 0)
                {
                    foreach (var adultIEFields in lstadultIEFields)
                    {
                        ...
                        oUtility.AddParameters("@VisitDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.VisitDate).ToString()));
                        oUtility.AddParameters("@StartTime", SqlDbType.VarChar, String.Format("{0:yyyy-MM-dd hh:mm:ss}", DateTime.Now));
                        theDT = (DataTable)expressManagerTest.ReturnObject(oUtility.theParams, "Pr_clinical_addadultie_CATab", ClsUtility.ObjectEnum.DataTable);
            ...
            try
            {
                ...
                if (lstadultIEFields.Count > 0)
                {
                    foreach (var adultIEFields in lstadultIEFields)
                    {
                        ...
                        oUtility.AddParameters("@InitialCD4", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.InitialCD4).ToString());
                        oUtility.AddParameters("@InitialCD4Percent", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.InitialCD4Percent).ToString());
                        oUtility.AddParameters("@InitialCD4Date", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.InitialCD4Date).ToString()));
                        oUtility.AddParameters("@HighestCD4Ever", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.HighestCD4Ever).ToString());
                        oUtility.AddParameters("@HighestCD4Percent", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.HighestCD4Percent).ToString());
                        oUtility.AddParameters("@HighestCD4EverDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.HighestCD4EverDate).ToString()));
                        oUtility.AddParameters("@CD4atARTInitiation", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.CD4atARTInitiation).ToString());
                        oUtility.AddParameters("@CD4AtARTInitiationPercent", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.CD4AtARTInitiationPercent).ToString());
                        oUtility.AddParameters("@CD4atARTInitiationDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.CD4atARTInitiationDate).ToString()));
                        oUtility.AddParameters("@MostRecentCD4", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.MostRecentCD4).ToString());
                        oUtility.AddParameters("@MostRecentCD4Percent", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.MostRecentCD4Percent).ToString());
                        ...
                        oUtility.AddParameters("@PreviousViralLoad", SqlDbType.Decimal, ConverTotValue.NullToInt(adultIEFields.PreviousViralLoad).ToString());
                        oUtility.AddParameters("@PreviousViralLoadDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.PreviousViralLoadDate).ToString()));
                        oUtility.AddParameters("@OtherHIVRelatedHistory", SqlDbType.VarChar, ConverTotValue.NullToString(adultIEFields.OtherHIVRelatedHistory).ToString());

                        oUtility.AddParameters("@PMTC1StartDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.PMTC1StartDate).ToString()));
                        oUtility.AddParameters("@PMTC1Regimen", SqlDbType.VarChar, ConverTotValue.NullToString(adultIEFields.PMTC1Regimen).ToString());
                        oUtility.AddParameters("@PEP1Regimen", SqlDbType.VarChar, ConverTotValue.NullToString(adultIEFields.PEP1Regimen).ToString());
                        oUtility.AddParameters("@PEP1StartDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.PEP1StartDate).ToString()));
                        oUtility.AddParameters("@HAART1Regimen", SqlDbType.VarChar, ConverTotValue.NullToString(adultIEFields.HAART1Regimen).ToString());
                        oUtility.AddParameters("@HAART1StartDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.HAART1StartDate).ToString()));
                        oUtility.AddParameters("@ARVExposerdosesmissed", SqlDbType.Int, ConverTotValue.NullToInt(adultIEFields.ARVExposerdosesmissed).ToString());
                        oUtility.AddParameters("@ARVExposerdelaydoses", SqlDbType.Int, ConverTotValue.NullToInt(adultIEFields.ARVExposerdelaydoses).ToString());
                        oUtility.AddParameters("@Impression", SqlDbType.VarChar, ConverTotValue.NullToString(adultIEFields.Impression).ToString());
                        ...
                        oUtility.AddParameters("@TannerStaging", SqlDbType.Int, ConverTotValue.NullToInt(adultIEFields.TannerStaging).ToString());
                        oUtility.AddParameters("@Mernarche", SqlDbType.Int, ConverTotValue.NullToInt(adultIEFields.Mernarche).ToString());
                        oUtility.AddParameters("@MernarcheDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToInt(adultIEFields.Mernarchedate).ToString()));
                        oUtility.AddParameters("@StartTime", SqlDbType.VarChar, String.Format("{0:yyyy-MM-dd hh:mm:ss}", DateTime.Now));

                        theDT = (DataTable)expressManagerTest.ReturnObject(oUtility.theParams, "Pr_clinical_addadultie_ExamTab", ClsUtility.ObjectEnum.DataTable);
            ...
            try
            {
                ...
                if (lstadultIEFields.Count > 0)
                {
                    foreach (var adultIEFields in lstadultIEFields)
                    {
                        ...
                        oUtility.AddParameters("@VisitDate", SqlDbType.VarChar, String.Format("{0:dd-MMM-yyyy}",ConverTotValue.NullToDate(adultIEFields.VisitDate).ToString()));
                        oUtility.AddParameters("@StartTime", SqlDbType.VarChar, String.Format("{0:yyyy-MM-dd hh:mm:ss}", DateTime.Now));
                        theDT = (DataTable)expressManagerTest.ReturnObject(oUtility.theParams, "Pr_clinical_addadultie_MgtTab", ClsUtility.ObjectEnum.DataTable);
