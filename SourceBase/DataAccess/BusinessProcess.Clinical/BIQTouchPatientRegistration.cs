...
namespace BusinessProcess.Clinical
{
    public class BIQTouchPatientRegistration : ProcessBase, IIQTouchPatientRegistration
    {
        ...
        public DataSet GetRegistrationDetails(int PatientID, string LocationID)
        {
            ...
            oUtility.AddParameters("@Password", SqlDbType.VarChar, ApplicationAccess.DBSecurity.Replace("'",""));
            ClsObject RecordMgr = new ClsObject();
            DataSet regDT = (DataSet)RecordMgr.ReturnObject(oUtility.theParams, "pr_Clinical_IQTouchGetRegistration", ClsUtility.ObjectEnum.DataSet);
            return regDT;
        ...
        public DataTable GetCareGiverInfo(string PatientID)
        {
            try
            {
                ...
                oUtility.AddParameters("@ptn_pk", SqlDbType.VarChar, PatientID);
                ClsObject RegMan = new ClsObject();
                RegMan.Connection = this.Connection;
                RegMan.Transaction = this.Transaction;
                DataTable getCGREcs = (DataTable)RegMan.ReturnObject(oUtility.theParams, "Pr_IQTouch_CareGiver_Get", ClsUtility.ObjectEnum.DataTable);
        ...
        public DataTable GetCareGiverInfoFromVisit(string PatientID)
        {
            try
            {
                ...
                RegMan.Connection = this.Connection;
                RegMan.Transaction = this.Transaction;
                DataTable getCGREcs = (DataTable)RegMan.ReturnObject(oUtility.theParams, "Pr_IQTouch_CareGiver_FromVisit_Get", ClsUtility.ObjectEnum.DataTable);
        ...
        public int SavePatientRecord(string LocationID, string FirstName, string LastName, string Sex, string DOB, string MiddleName, string D9FolderNo)
        {
            lock (this)
            {
                try
                {
                    ...
                    oUtility.AddParameters("@Sex", SqlDbType.Int, Sex);
                    oUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID);
                    oUtility.AddParameters("@DOB", SqlDbType.VarChar, DOB);
                    oUtility.AddParameters("@MiddleName", SqlDbType.VarChar, MiddleName);
                    oUtility.AddParameters("@D9FolderNo", SqlDbType.VarChar, D9FolderNo);
                    ...
                    RegMan.Connection = this.Connection;
                    RegMan.Transaction = this.Transaction;
                    int NewPatientID = (int)RegMan.ReturnObject(oUtility.theParams, "Pr_IQTouch_Patient_Add", ClsUtility.ObjectEnum.ExecuteNonQuery);
        ...
        public int SaveRegistrationDetails(objRegistration theReg, string PatientID, string LocationID, string UserID)
        {
            lock (this)
            {
                try
                {
                    ...
                    oUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID);
                    oUtility.AddParameters("@FirstName", SqlDbType.VarChar, theReg.FirstName);
                    oUtility.AddParameters("@LastName", SqlDbType.VarChar, theReg.LastName);
                    oUtility.AddParameters("@RegistrationDate", SqlDbType.VarChar, theReg.RegistrationDate);
                    oUtility.AddParameters("@Sex", SqlDbType.Int, theReg.Sex.ToString());
                    oUtility.AddParameters("@DOB", SqlDbType.VarChar, theReg.DOB);
                    oUtility.AddParameters("@password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
                    oUtility.AddParameters("@Address", SqlDbType.VarChar, theReg.Address);
                    oUtility.AddParameters("@Village", SqlDbType.VarChar, theReg.Suburb);
                    oUtility.AddParameters("@Town", SqlDbType.Int, theReg.SubDistrict);
                    oUtility.AddParameters("@DistrictName", SqlDbType.Int, theReg.District);
                    oUtility.AddParameters("@Phone", SqlDbType.VarChar, theReg.TelephoneNo);
                    oUtility.AddParameters("@ReferredFrom", SqlDbType.Int, theReg.EntryPoint.Split('|')[0]);
                    oUtility.AddParameters("@ReferredFromSpecify", SqlDbType.VarChar, theReg.OtherEntryPoint);

                    //Contact detail params
                    oUtility.AddParameters("@AddressComment", SqlDbType.VarChar, theReg.Addresscomments);
                    oUtility.AddParameters("@OtherAddress", SqlDbType.VarChar, theReg.PostalAddress);
                    oUtility.AddParameters("@OtherPOBoxNo", SqlDbType.VarChar, theReg.PostalCode);
                    oUtility.AddParameters("@GuardianName", SqlDbType.VarChar, theReg.CareGiverName);
                    oUtility.AddParameters("@Guardian_DOB", SqlDbType.VarChar, theReg.CareGiverDOB);
                    oUtility.AddParameters("@GuardianGender", SqlDbType.Int, theReg.CareGiverGender.ToString());
                    oUtility.AddParameters("@EmergContactRelation", SqlDbType.VarChar, theReg.CareGiverRelationship.ToString());
                    oUtility.AddParameters("@EmergContactRelationOther", SqlDbType.VarChar, theReg.OtherCareGiver);
                    oUtility.AddParameters("@EmergContactPhone", SqlDbType.VarChar, theReg.CareGiverTelephone);

                    //Mother's History params
                    oUtility.AddParameters("@MotherName", SqlDbType.VarChar, theReg.MotherName);

                    if (theReg.MotherAliveYN.ToString() != "")
                    {
                        oUtility.AddParameters("@MotherAliveYN", SqlDbType.Int, Convert.ToInt32(bool.Parse(theReg.MotherAliveYN.ToString().ToLower())).ToString());
                    }
                    oUtility.AddParameters("@MotherPMTCTdrugsYN", SqlDbType.Int, theReg.MotherPMTCTdrugsYN.ToString());
                    ...
                    oUtility.AddParameters("@MotherPMTCTdrugs", SqlDbType.VarChar, MotherPMTCTDrugList);
                    oUtility.AddParameters("@ChildPMTCTdrugsYN", SqlDbType.Int, theReg.ChildPMTCTdrugsYN.ToString());
                    ...
                    oUtility.AddParameters("@ChildPMTCTdrugs", SqlDbType.VarChar, ChildPMTCTDrugList);
                    oUtility.AddParameters("@MotherARTYN", SqlDbType.Int, theReg.MotherARTYN.ToString());
                    oUtility.AddParameters("@FeedingOption", SqlDbType.Int, theReg.FeedingOption.ToString());

                    //HIV Care params
                    oUtility.AddParameters("@HIVPosDateConfirmed", SqlDbType.VarChar, theReg.DateConfirmedHIVPositive);
                    oUtility.AddParameters("@HIVCareDateEnrolled", SqlDbType.VarChar, theReg.DateEnrolledHIVCare);
                    oUtility.AddParameters("@WHOStageAtEnrollment", SqlDbType.Int, theReg.WHOStageAtEnrollment.ToString());

                    //Transfer In params
                    oUtility.AddParameters("@TransferInDate", SqlDbType.VarChar, theReg.TransferInDate);
                    oUtility.AddParameters("@TransferFromDistrict", SqlDbType.Int, theReg.FromDistrict.ToString());
                    oUtility.AddParameters("@TransferFromFacility", SqlDbType.Int, theReg.Facility.ToString());
                    oUtility.AddParameters("@DateStartedFirstRegimen", SqlDbType.VarChar, theReg.DateStart);
                    ...
                    oUtility.AddParameters("@Regimen", SqlDbType.VarChar, theReg.RegimenAbbreviations);
                    oUtility.AddParameters("@RegimenIDs", SqlDbType.VarChar, Regimens);

                    oUtility.AddParameters("@Weight", SqlDbType.Decimal, theReg.Weight);
                    oUtility.AddParameters("@Height", SqlDbType.Decimal, theReg.Height);
                    oUtility.AddParameters("@Whostage", SqlDbType.Int, theReg.WHOStageAtTransfer.ToString());

                    oUtility.AddParameters("@PriorART", SqlDbType.VarChar, theReg.PriorART);
                    ...
                    RegMan.Connection = this.Connection;
                    RegMan.Transaction = this.Transaction;
                    int RecsAffected = (int)RegMan.ReturnObject(oUtility.theParams, "pr_Clinical_IQTouchSaveRegistration", ClsUtility.ObjectEnum.ExecuteNonQuery);
                    ...
                    if (theReg.PriorART == "1")
                    {
                        ...
                        foreach (var item in theReg.PriorARTRegimens)
                        {
                            ...
                            oUtility.AddParameters("@PatientID", SqlDbType.Int, PatientID);
                            oUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID);
                            oUtility.AddParameters("@RegimenID", SqlDbType.Int, item.RegimenID.ToString());
                            oUtility.AddParameters("@Regimen", SqlDbType.VarChar, item.Regimen.ToString());
                            oUtility.AddParameters("@RegimenDate", SqlDbType.VarChar, item.PriorARTDateLastUsed);
                            oUtility.AddParameters("@PurposeID", SqlDbType.Int, Purpose.ToString());
                            ClsObject RegManPrior = new ClsObject();
                            RegManPrior.Connection = this.Connection;
                            RegManPrior.Transaction = this.Transaction;
                            int recsinserted = (int)RegManPrior.ReturnObject(oUtility.theParams, "pr_Clinical_IQTouchSaveRegistration_PriorART", ClsUtility.ObjectEnum.ExecuteNonQuery);
                        }
                    }
                    ...
                    if (theReg.DrugAllergies.Count > 0)
                    {
                        foreach (var item in theReg.DrugAllergies)
                        {
                            ...
                            oUtility.AddParameters("@PatientID", SqlDbType.Int, PatientID);
                            oUtility.AddParameters("@LocationID", SqlDbType.Int, LocationID);
                            oUtility.AddParameters("@AllergenID", SqlDbType.Int, item.AllergenID.ToString());
                            oUtility.AddParameters("@AllergenName", SqlDbType.VarChar, item.Allergen);
                            oUtility.AddParameters("@ReactionType", SqlDbType.VarChar, item.TypeOfReaction);
                            oUtility.AddParameters("@AllergyDate", SqlDbType.VarChar, item.DateOfAllergy);
                            oUtility.AddParameters("@MedicalConditions", SqlDbType.VarChar, item.MedicalConditions);
                            oUtility.AddParameters("@UserID", SqlDbType.Int, UserID);
                            ...
                            int DrugsInserted = (int)RegManDrugAllergy.ReturnObject(oUtility.theParams, "pr_Clinical_IQTouchSaveRegistration_DrugAllergy", ClsUtility.ObjectEnum.ExecuteNonQuery);
                        }
                    }
        ...
        public DataSet GetPatientSearchResults(int FId, string lastname, string middlename, string firstname, string enrollment, string gender, DateTime dob, string status,int ModuleId,string FolderNo)
        {
            lock (this)
            {
                ...
                oUtility.AddParameters("@FolderNo", SqlDbType.VarChar, FolderNo.ToString());
                oUtility.AddParameters("@password", SqlDbType.VarChar, ApplicationAccess.DBSecurity);
                ClsObject UserManager = new ClsObject();
