    ...
    public class BQueryBuilder:ProcessBase,IQueryBuilder
    {
        ...
        public DataSet ReturnQueryResult(string theQuery)
        {
            lock (this)
            {
                ...
                oUtility.AddParameters("@QryString", SqlDbType.VarChar, theNewQry);
        ...
        public DataTable SaveCustomReport(Int32 ReportId,Int32 CategoryId,string CategoryName,string ReportName, string ReportQuery,Int32 UserId)
        {
            lock (this)
            {
                ...
                oUtility.AddParameters("@CategoryId", SqlDbType.Int, CategoryId.ToString());
                oUtility.AddParameters("@CategoryName", SqlDbType.VarChar, CategoryName);
                oUtility.AddParameters("@ReportName", SqlDbType.VarChar, ReportName);
                oUtility.AddParameters("@ReportQuery", SqlDbType.VarChar, ReportQuery);
                oUtility.AddParameters("@UserId", SqlDbType.VarChar, UserId.ToString());
                return (DataTable)theQB.ReturnObject(oUtility.theParams, "pr_SaveCustomReports_Futures", ClsUtility.ObjectEnum.DataTable);
            }
        }
        ...
        public DataSet ExportReport(int ReportId)
        {
            lock (this)
            {
                ...
                ClsObject theQB = new ClsObject();
                oUtility.AddParameters("@ReportId", SqlDbType.Int, ReportId.ToString());
                return (DataSet)theQB.ReturnObject(oUtility.theParams, "pr_Reports_QueryBuilderExport_Futures", ClsUtility.ObjectEnum.DataSet);
            }
        }
        //QueryBuilder Report
        ...
        public int SaveUpdateQueryBuilderReport(DataSet dsReportDetails,Int32 theUserId)
        {
            lock (this)
            {
                ...
                oUtility.Init_Hashtable();
                oUtility.AddParameters("@CategoryName", SqlDbType.VarChar, dsReportDetails.Tables[0].Rows[0]["CategoryName"].ToString());
                oUtility.AddParameters("@ReportName", SqlDbType.VarChar, dsReportDetails.Tables[1].Rows[0]["ReportName"].ToString());
                oUtility.AddParameters("@ReportQuery", SqlDbType.VarChar, dsReportDetails.Tables[1].Rows[0]["ReportQuery"].ToString());
                oUtility.AddParameters("@UserId", SqlDbType.VarChar, theUserId.ToString());
                int theRowAffected = (int)QueryBuilderReport.ReturnObject(oUtility.theParams, "pr_QueryBuilderReportSaveUpdate_Futures", ClsUtility.ObjectEnum.ExecuteNonQuery);
