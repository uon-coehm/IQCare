...
namespace Touch.Custom_Forms
{
    ...
    public partial class frmImmunisationTouch : TouchUserControlBase
    {
            ...
            try
            {
                ...
                foreach (RadButton radbtn in lstRadButton)
                {
                    ...
                    if (radbtn.SelectedToggleState.Text.ToString().ToUpper() == "YES")
                    {
                        ...
                        //obj.ImmunisationDate = Convert.ToDateTime(dtDateBCG.DbSelectedDate.ToString());
                        ...
                        switch (radbtn.ID)
                        {
                            case "btnBCG": //1
                                ...
                                obj.ImmunisationDate = DateGiven(dtDateBCG.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "BCG";
                                ImmunisationFlag = true;
                                break;
                            case "btnOPV0"://2
                                obj.ImmunisationDate = DateGiven(dtOPV0Date.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "OPV0";
                                ImmunisationFlag = true;
                                break;
                            case "btnOPV1"://3
                                obj.ImmunisationDate = DateGiven(dtDateOPV1.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_OPV1.SelectedToggleState.Text);
                                obj.ImmunisationCode = "OPV1";
                                ImmunisationFlag = true;
                                break;
                            case "btnRV1"://4
                                obj.ImmunisationDate = DateGiven(dtDateRV1.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "RV1";
                                ImmunisationFlag = true;
                                break;
                            case "btnDTaP1"://5
                                obj.ImmunisationDate = DateGiven(dtDateDTaP1.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "DTaP-IPV-Hib1";
                                ImmunisationFlag = true;
                                break;
                            case "btnHEP1"://6
                                obj.ImmunisationDate = DateGiven(dtDateHepB1.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_HEP1.SelectedToggleState.Text);
                                obj.ImmunisationCode = "Hep B1";
                                ImmunisationFlag = true;
                                break;
                            case "btmPCV1"://7
                                obj.ImmunisationDate = DateGiven(dtDatePCV1.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_PCV1.SelectedToggleState.Text);
                                obj.ImmunisationCode = "PCV1";
                                ImmunisationFlag = true;
                                break;
                            case "btnDTaP2"://8
                                obj.ImmunisationDate = DateGiven(dtDateDTaP2.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "DTaP-IPV-Hib2";
                                ImmunisationFlag = true;
                                break;
                            case "btnHEP2"://9
                                obj.ImmunisationDate = DateGiven(dtDateHepB2.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_HEP2.SelectedToggleState.Text);
                                obj.ImmunisationCode = "Hep B2";
                                ImmunisationFlag = true;
                                break;
                            case "btnDTaP3"://10
                                obj.ImmunisationDate = DateGiven(dtDateDTaP3.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "DTaP-IPV-Hib3";
                                ImmunisationFlag = true;
                                break;
                            case "btnHEP3"://11
                                obj.ImmunisationDate = DateGiven(dtDateHepB3.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_HEP3.SelectedToggleState.Text);
                                obj.ImmunisationCode = "Hep B3";
                                ImmunisationFlag = true;
                                break;
                            case "btnPCV2"://12
                                obj.ImmunisationDate = DateGiven(dtDatePCV2.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_PCV2.SelectedToggleState.Text);
                                obj.ImmunisationCode = "PCV2";
                                ImmunisationFlag = true;
                                break;
                            case "btnRV2"://13
                                obj.ImmunisationDate = DateGiven(dtDateRV2.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "RV2";
                                ImmunisationFlag = true;
                                break;
                            case "btnMeasles1"://14
                                obj.ImmunisationDate = DateGiven(dtDateMeasles1.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_Measles1.SelectedToggleState.Text);
                                obj.ImmunisationCode = "Measles1";
                                ImmunisationFlag = true;
                                break;
                            case "btnPCV3": //15
                                obj.ImmunisationDate = DateGiven(dtDatePVC3.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_PCV3.SelectedToggleState.Text);
                                obj.ImmunisationCode = "PCV3";
                                ImmunisationFlag = true;
                                break;
                            case "btnDTaP4": //16
                                obj.ImmunisationDate = DateGiven(dtDateDTaP4.DbSelectedDate.ToString());
                                obj.ImmunisationCode = "DTaP-IPV-Hib4";
                                ImmunisationFlag = true;
                                break;
                            case "btnMeasles2"://17
                                obj.ImmunisationDate = DateGiven(dtDateMeasles2.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_Measles2.SelectedToggleState.Text);
                                obj.ImmunisationCode = "Measles2";
                                ImmunisationFlag = true;
                                break;
                            case "btnTD6yrs"://18
                                obj.ImmunisationDate = DateGiven(dtDateTd6Yrs.DbSelectedDate.ToString());
                                obj.ImmunisationCU = CheckedVaue(btnCUGT_Td6yrs.SelectedToggleState.Text);
                                obj.ImmunisationCode = "Td - 6 yrs";
                                ImmunisationFlag = true;
                                break;
                            case "btnTd12yrs": //19
                                obj.ImmunisationDate = DateGiven(dtDateTd23Yrs.DbSelectedDate.ToString());
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //RadbtnSave.Attributes.Add("OnClick", "return ValidateImmunisationForm('" + hddErrormsg.ClientID + "','" + HddErrorFlag.ClientID + "');");
            ...
            if (e.CommandName == "Insert")
            {
                if (RadOtherVaccine != null)
                {
                    ...
                    if (footeritem != null)
                    {
                        ...
                        if (ValidateAddImmunisation(txtimmuOther.Text.ToString(), dtFooterOtherDate.DbSelectedDate, btnFooterOthers.SelectedToggleState.Text.ToString()) == false)
                        {
                        ...
                        DR["ImmunisationDate"] = Convert.ToDateTime(dtFooterOtherDate.DbSelectedDate.ToString()).ToShortDateString();
