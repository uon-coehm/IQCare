<%@ Control Language="C#" AutoEventWireup="true" CodeFile="frmRegistrationTouch.ascx.cs" Inherits="Touch.Custom_Forms.frmRegistrationTouch" %>
<telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
    <script type="text/javascript">
        function OnBlurTxt() {
            alert('here');
            var hgt = $('#<%=txtHeight.ClientID%>').val();
            var wgt = $('#<%=txtWeight.ClientID%>').val();

            if ((hgt != "") && (wgt != "")) {

                var BMI = wgt / (hgt * hgt);
                $('#<%=txtBMICalculated.ClientID%>').val(BMI.toString());
            }
        }
    </script>
...
<div id="tabs" style="width:800px">
             ...
             <table cellpadding="10px" class="Section" >
                ...
                <tr>
                 <td style="width:23%;">
                        Date of birth *</td>
                    <td style="width:27%;">
                        <telerik:RadDatePicker ID="dtPatientDOB" runat="server" Skin="MetroTouch" >
                    ...
                    <td>
                        <telerik:RadButton ID="RadButton1" runat="server" Skin="MetroTouch" Text="Cal DOB">
                        </telerik:RadButton>
                    </td>
                    </tr>
                    </table></td>
                ...
                <tr>
                    <td style="width:23%;">
                        Sub district</td>
                    <td style="width:27%;">
                        <telerik:RadComboBox ID="rcbSubDistrict" runat="server" Skin="MetroTouch">
                        </telerik:RadComboBox>
                    </td>
                    <td style="width:23%;">
                        District</td>
                    <td style="width:27%;">
                        <telerik:RadComboBox ID="rcbDistrict" runat="server" Skin="MetroTouch">
                        </telerik:RadComboBox>
                    </td>
                </tr>
                <tr>
        ...
        <table cellpadding="10px"   class="Section">
                ...
                <tr>
                    <td style="width:23%;">
                        <span class="Emphasis">Caregiver first name</span></td>
                    <td style="width:27%;">
                ...
                <tr>
                 <td style="width:23%;">
                        Caregiver DOB</td>
                    <td style="width:27%;">
                        <telerik:RadDatePicker ID="dtCGDOB" runat="server" Skin="MetroTouch">
                   ...
                   <td style="width:27%;"><table>
                    ...
                    <td>
                        <telerik:RadButton ID="CGCalDOB" runat="server" Skin="MetroTouch" OnClientClicking="CalcDOB_Click()" Text="Cal DOB">
                        </telerik:RadButton>
                        
                        <telerik:RadScriptBlock runat="server" ID="rsb1">
                            <script type="text/javascript">
                                function CalcDOB_click() {
                                    alert($('#<%=txtBMICalculated.ClientID%>').val());
                                    return false;
                                }
            ...
            <table cellpadding="10px" class="Section" >
                <tr>
                    ...
                    <td style="width:23%;">
                        From District</td>
                    <td style="width:28%;">
                         <telerik:RadComboBox ID="RadComboBox3" runat="server" Skin="MetroTouch">
                             <Items>
                                 <telerik:RadComboBoxItem runat="server" Text="Select" Value="Select" />
                ...
                <tr>
                    <td style="width:23%;">
                        Facility</td>
                    <td style="width:28%;">
                         <telerik:RadComboBox ID="RadComboBox4" runat="server" Skin="MetroTouch">
                             <Items>
                                 <telerik:RadComboBoxItem runat="server" Text="Select" Value="Select" />
...
<div id="tab8" class="scroll-pane jspScrollable tabwidth" style="width:811px; overflow:hidden; height: 380px;">
            ...
            <table id="Table2" cellpadding="10px" class="Section" >
                <tr>
                  ...
                  <tr>
                    <td style="width:23%;">
                        Allergen</td>
                    <td style="width:28%;">
                        <telerik:RadTextBox ID="RadTextBox3" runat="server" Skin="MetroTouch" 
                            Width="200px" >
                        </telerik:RadTextBox>
                    </td>
                    <td style="width:23%;">
                        Type of reaction</td>
                    <td style="width:28%;">
                        <telerik:RadTextBox ID="RadTextBox4" runat="server" Skin="MetroTouch" 
                             Width="200px" >
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width:28%;">
                         <telerik:RadDatePicker ID="dtReactionDate" runat="server" Skin="MetroTouch">
                            <Calendar ID="Calendar8" UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" 
                                                Skin="MetroTouch" runat="server"></Calendar>
                            <DateInput ID="DateInput8" DisplayDateFormat="dd MMM yyyy" DateFormat="dd/MM/yyyy" LabelWidth="0px" runat="server">
                    ...
                    <td style="width:23%;">
                        Relevant medical conditions</td>
                    <td style="width:28%;">
                        <telerik:RadTextBox ID="RadTextBox6" runat="server" Skin="MetroTouch" 
                             Width="200px" >
                        </telerik:RadTextBox>
                    </td>
                </tr>
