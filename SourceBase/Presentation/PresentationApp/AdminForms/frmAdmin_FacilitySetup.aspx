        ...
        <div class="border center formbg" style="padding: 5px;">
            ...
            <table class="pad5 formbg" width="100%" border="0" cellpadding="0" cellspacing="6">
                ...
                <tr>
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Drug Stores" Font-Bold="True"></asp:Label>
                        <table width="100%">
                            <tr>
                                <td class="pad35">
                                    <div nowrap='nowrap' class="divBorder border left whitebg" align="left" id="Div1"
                                        runat="server" width="1%" style="cursor: pointer; height: 280px; overflow: auto;">
                                        <asp:CheckBoxList ID="cblStores" runat="server" RepeatLayout="Flow" Width="70%">
                                        </asp:CheckBoxList>
                                    </div>
                                </td>
                            </tr>
