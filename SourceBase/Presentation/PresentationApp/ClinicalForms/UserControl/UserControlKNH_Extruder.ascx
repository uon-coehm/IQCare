...
<%@ Register src="UserControlKNH_WorkPlanExtruder.ascx" tagname="UserControlKNH_WorkPlanExtruder" tagprefix="uc5" %>
<%@ Register src="UserControl_Nutrition.ascx" tagname="UserControl_Nutrition" tagprefix="uc6" %>
<%@ Register src="UserControlKNH_HEIData.ascx" tagname="UserControlKNH_HEIData" tagprefix="uc7" %>
<%@ Register src="UserControlKNH_MEIdata.ascx" tagname="UserControlKNH_MEIData" tagprefix="uc8" %>
<style type="text/css">
        body{
...
<script src="../Touch/scripts/mbExtruder.js" type="text/javascript"></script>--%>
    ...
    <div class="longText" style="position:relative;padding-left:50px">
        ...
        <div id="extruderLeft2" class="a {title:'Work Plan'}" >
        ...
        <div id="extruderLeft4" class="a {title:'Reproductive Health'}" >
            <uc7:UserControlKNH_HEIData ID="UserControlKNH_HEIData1" runat="server" />
            <uc8:UserControlKNH_MEIData ID="UserControlKNH_MEIData1" runat="server" />
        </div>
    </div>
