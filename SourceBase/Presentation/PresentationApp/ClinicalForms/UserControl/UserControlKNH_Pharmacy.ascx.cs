...
namespace PresentationApp.ClinicalForms.UserControl
{
    public partial class UserControlKNH_Pharmacy : System.Web.UI.UserControl
    {
        ...
        public void GetLastregimenDispensed()
        {
            ...
            if (lastRegimenDispensedDS.Tables[0].Rows.Count > 0)
            {
                lblLastRegimenDispensed.Text = lastRegimenDispensedDS.Tables[0].Rows[0][0].ToString();
            }
            else
            {
        ...
        public void fillDropDown()
        {
            ...
            chklistARTstopcode.Attributes.Add("OnClick", "CheckBoxHideUnhide('" + chklistARTstopcode.ClientID + "','divARTstopcodeother','Other patient decision')");
