                                    ...
                                    <asp:GridView ID="gvWHO1" runat="server" AutoGenerateColumns="false" Width="800px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Current" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWho1Date" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');"  />
                                            ...
                                            <asp:TemplateField HeaderText="Historic" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWho1Date1" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                ...
                                <asp:Panel ID="PnlWHO2" runat="server" ScrollBars="Vertical" Height="200px">
                                    <asp:GridView ID="gvWHO2" runat="server" AutoGenerateColumns="false" Width="800px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Current" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWho2Date" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                            ...
                                            <asp:TemplateField HeaderText="Historic" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWho2Date1" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                ...
                                <asp:Panel ID="PnlWHO3" runat="server" ScrollBars="Vertical" Height="200px">
                                    <asp:GridView ID="gvWHO3" runat="server" AutoGenerateColumns="false" Width="800px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Current" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWHO3Date" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                            ...
                                            <asp:TemplateField HeaderText="Historic" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWho3Date1" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                ...
                                <asp:Panel ID="PnlWHO4" runat="server" ScrollBars="Vertical" Height="200px">
                                    <asp:GridView ID="gvWHO4" runat="server" AutoGenerateColumns="false" Width="800px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Current" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWHO4Date" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                            ...
                                            <asp:TemplateField HeaderText="Historic" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <input id="txtCurrentWho4Date1" maxlength="11" size="8" name="visitDate" runat="server" onkeyup="DateFormat(this,this.value,event,false,'3');" />
                                                                    ...
                                                                    <table class="tbl-left">
                                                                        <tr>
                                                                            <td align="right" class="data-lable">
                                                                                ...
                                                                                <asp:Label ID="lblTannerStage1" runat="server" CssClass="required" Font-Bold="True"
                                                                                    Text="*Tanner Staging:"></asp:Label>
                                                                            </td>
                                                                            <td align="left" class="data-control">
