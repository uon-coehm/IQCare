                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style='width: 50%' align='left'>
                                                            ...
                                                            <img ID="Img1" alt="Date Helper" border="0" height="22 " hspace="5" 
                                                                ...
                                                                src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span class="smallerlabel"
                ...
                <act:TabPanel ID="TabpnlManagement" runat="server" Font-Size="Medium" HeaderText="Management">
                    ...
                    <ContentTemplate>
                                ...
                                <tr>
                                    <td align="left">
                                        <asp:Panel ID="pnlOITreatment" CssClass="border center formbg" runat="server" Style="padding: 6px">
                                            <h2 class="forms" align="left">
                                                <asp:ImageButton ID="imgOITreatment" runat="server" 
                                        ...
                                        <td style='width: 50%' colspan="2">
                                            <table width='100%'>
                                                <tr>
                                                    ...
                                                    <td style='width: 60%' align='left'>
                                                        <asp:DropDownList ID="rcbOIProphylaxis" runat="server" Width="130px">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <div id="DIVCotrimoxazole" style="display: none;">
                                                <table width='100%'>
                                                    <tr>
                                                        ...
                                                        <td style='width: 50%' align='left'>
                                                            <asp:DropDownList ID="rcbReasonCTXPrescribed" runat="server"
                                                                Width="130px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                        ...
                        <act:CollapsiblePanelExtender ID="CPEOITreatment" runat="server" SuppressPostBack="True"
                            ...
                            Collapsed="True" ImageControlID="imgOITreatment" Enabled="True">
                        </act:CollapsiblePanelExtender>
                        <br />
                        <div class="border center formbg">
                            <table cellspacing="6" cellpadding="0" width="100%" border="0">
