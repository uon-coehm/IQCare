...
namespace PresentationApp.ClinicalForms
{
    ...
    public partial class frmClinical_KNH_AdultIE : BasePage // System.Web.UI.Page
    {
        ...
        private void BindAttributes()
        {
            ...
            ddlPatientReferred.Attributes.Add("onchange", "getSelectedValue('divPatRefother', '" + ddlPatientReferred.ClientID + "' ,'Other')");
        ...
        { 
            ...
            BindDropdown(ddlPatientReferred, "Patient Referred");
