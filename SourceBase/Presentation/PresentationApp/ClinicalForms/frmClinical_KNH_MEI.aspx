...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function calculategestation() {
            var lmp = document.getElementById('<%=txtLMPDate.ClientID%>').value;
            var txtGest = document.getElementById('<%=txtGestation.ClientID%>');
            var txtEDD = document.getElementById('<%=txtEDD.ClientID%>');
            ...
            if (dateparts[1] == "Jan" || dateparts[1] == "JAN") {
                lmpMonth = 1;
            }
            else if (dateparts[1] == "Feb" || dateparts[1] == "FEB") {
                lmpMonth = 2;
            }
            else if (dateparts[1] == "Mar" || dateparts[1] == "MAR") {
                lmpMonth = 3;
            }
            else if (dateparts[1] == "Apr" || dateparts[1] == "APR") {
                lmpMonth = 4;
            }
            else if (dateparts[1] == "May" || dateparts[1] == "MAY") {
                lmpMonth = 5;
            }
            else if (dateparts[1] == "Jun" || dateparts[1] == "JUN") {
                lmpMonth = 6;
            }
            else if (dateparts[1] == "Jul" || dateparts[1] == "JUL") {
                lmpMonth = 7;
            }
            else if (dateparts[1] == "Aug" || dateparts[1] == "AUG") {
                lmpMonth = 8;
            }
            else if (dateparts[1] == "Sep" || dateparts[1] == "SEP") {
                lmpMonth = 9;
            }
            else if (dateparts[1] == "Oct" || dateparts[1] == "OCT") {
                lmpMonth = 10;
            }
            else if (dateparts[1] == "Nov" || dateparts[1] == "NOV") {
                lmpMonth = 11;
            }
            else if (dateparts[1] == "Dec" || dateparts[1] == "DEC") {
                lmpMonth = 12;
            }

            var lmpdate = new Date(dateparts[2], lmpMonth - 1, dateparts[0]);
            var today = new Date();

            var utc1 = Date.UTC(lmpdate.getFullYear(), lmpdate.getMonth(), lmpdate.getDate());
            var utc2 = Date.UTC(today.getFullYear(), today.getMonth(), today.getDate());

            var eddDate = new Date(lmpdate);
            eddDate.setDate(eddDate.getDate() + 280);

            var edddate_d = eddDate.getDate();
            var edddate_m;
            var edddate_month = eddDate.getMonth() + 1;
            var edddate_y = eddDate.getFullYear();

            if (edddate_month == 1) {
                edddate_m = "Jan";
            }
            else if (edddate_month == 2) {
                edddate_m = "Feb";
            }
            else if (edddate_month == 3) {
                edddate_m = "Mar";
            }
            else if (edddate_month == 4) {
                edddate_m = "Apr";
            }
            else if (edddate_month == 5) {
                edddate_m = "May";
            }
            else if (edddate_month == 6) {
                edddate_m = "Jun";
            }
            else if (edddate_month == 7) {
                edddate_m = "Jul";
            }
            else if (edddate_month == 8) {
                edddate_m = "Aug";
            }
            else if (edddate_month == 9) {
                edddate_m = "Sep";
            }
            else if (edddate_month == 10) {
                edddate_m = "Oct";
            }
            else if (edddate_month == 11) {
                edddate_m = "Nov";
            }
            else if (edddate_month == 12) {
                edddate_m = "Dec";
            }

            txtGest.value = Math.round((utc2 - utc1) * 10 / (1000 * 60 * 60 * 24 * 7)) / 10;
            txtEDD.value = edddate_d + '-' + edddate_m + '-' + edddate_y;
        }

        function ShowHideDiscloseStatusDetails() {
            if (document.getElementById('<%=rdodisclosedHIVStatusNo.ClientID%>').checked) {
                document.getElementById('<%=lblHIVStatusDetails.ClientID%>').style.display = 'none';
                document.getElementById('div26').style.display = 'none';
            }

            if (document.getElementById('<%=rdodisclosedHIVStatusYes.ClientID%>').checked) {
                document.getElementById('<%=lblHIVStatusDetails.ClientID%>').style.display = 'block';
                document.getElementById('div26').style.display = 'block';
            }
        }

        function ShowHideSpecifyWardAdmitted() {
            if (document.getElementById('<%=rdoAdmittedtowardPMTCTNo.ClientID%>').checked) {
                document.getElementById('<%=lblSpecifyWardAdmitted.ClientID%>').style.display = 'none';
                document.getElementById('<%=ddlWardAdmitted.ClientID%>').style.display = 'none';
            }

            if (document.getElementById('<%=rdoAdmittedtowardPMTCTYes.ClientID%>').checked) {
                document.getElementById('<%=lblSpecifyWardAdmitted.ClientID%>').style.display = 'block';
                document.getElementById('<%=ddlWardAdmitted.ClientID%>').style.display = 'block';
            }
        }

        function ShowHideHIVtestDetails() {
            if (document.getElementById('<%=rdoHIVTestingTodayNo.ClientID%>').checked) {
                document.getElementById('<%=pnlHIVtestDetails.ClientID%>').style.display = 'block';
                document.getElementById('<%=pnlHIVtestDetails2.ClientID%>').style.display = 'none';
            }

            if (document.getElementById('<%=rdoHIVTestingTodayYes.ClientID%>').checked) {
                document.getElementById('<%=pnlHIVtestDetails.ClientID%>').style.display = 'block';
                document.getElementById('<%=pnlHIVtestDetails2.ClientID%>').style.display = 'block';
            }
        }
                    ...
                    <ContentTemplate>
                        <div class="border center formbg">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1ClientInformation" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label31" runat="server" Text="Client Information"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 50%;">
                                                                        <label id="lblLMP" runat="server" class="required margin35">
                                                                            LMP:</label>
                                                                        <input id="txtLMPDate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,3), calculategestation()"
                                                    ...
                                                    <tr>
                                                        <td class="pad5 whitebg">
                                                            <asp:DropDownList ID="ddlTTVaccine" runat="server" Style="display: none; width: 28%;
                                                                margin-left: 31.5%; margin-top: 0%;">
                                                            </asp:DropDownList>
                                                            <textarea id="txtNoTTReason" runat="server" cols="40" rows="1" style="margin-left: 31.5%;
                                                                margin-top: 0%; display: none;" placeholder="Give reason why TT vaccine wasn't issued"></textarea>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                            ...
                            <act:CollapsiblePanelExtender ID="CPEClientInformation" runat="server" SuppressPostBack="True"
                                ...
                                BehaviorID="_content_CPEClientInformation">
                            ...
                            <act:CollapsiblePanelExtender ID="CPEVitalSigns" runat="server" SuppressPostBack="True"
                                ...
                                ImageControlID="ImgPC" BehaviorID="_content_CPEVitalSigns">
                            </act:CollapsiblePanelExtender>
                        </div>
                        <br />
                        <div class="border center formbg">
                    ...
                    <ContentTemplate>
                        <div class="border center formbg">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1HTC" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="lblMHT" runat="server" Text="Maternal HIV Testing"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <asp:Panel ID="pnl2HTC" runat="server">
                                            <div id="MHT" style="display: none">
                                                <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                                                    ...
                                                                    <td style="width: 100%;">
                                                                        <label id="lblHIVTesting" runat="server" class="margin20 required">
                                                                            ...
                                                                            <input id="rdoHIVTestingTodayYes" type="radio" value="Yes" runat="server" name="HIVTestingToday"
                                                                                onclick="ShowHideHIVtestDetails()" />
                                                    ...
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <asp:Panel ID="pnlHIVtestDetails" runat="server" Style="display: none">
                                                                <table width="100%" border="0">
                                                                    <tr>
                                                                        <td style="width: 30%;">
                                                            ...
                                                            <asp:Panel ID="pnlHIVtestDetails2" runat="server" Style="display: none">
                                                                <table width="100%" border="0">
                                                                    <tr>
                                                                        <td style="width: 35%;">
                                                                        ...
                                                                        <td style="width: 30%;">
                                                                            <label id="Label8" runat="server" class="margin20">
                                                                                HIV Test done today?:
                                                                                <input id="rdoHIVTestingDoneTodayYes" type="radio" value="Yes" runat="server" name="HIVTestingDoneToday" />
                                                                                <label for="rdoHIVTestingDoneTodayYes">
                                                                                    Yes</label>
                                                                                <input id="rdoHIVTestingDoneTodayNo" type="radio" value="No" runat="server" name="HIVTestingDoneToday" />
                                                                                <label for="rdoHIVTestingDoneTodayNo">
                                                                                    No</label>
                                                                            </label>
                                                                        </td>
                                                                    </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="border pad5 whitebg" width="100%">
                                                                                <table width="100%" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 100%;">
                                                                                            <label id="Label6" runat="server" class="required margin20">
                                                                                                Final HIV result:
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PartnerHIVStatus" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label7" runat="server" Text="Partners HIV Status"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                ...
                                                <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 40%;">
                                                                        <label id="Label85" runat="server" class="margin20">
                                                                            Age of Partner:
                                                                        </label>
                                                                        <asp:TextBox ID="txtPartnerAge" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td style="width: 40%;">
                                                                        <label id="Label87" runat="server" class="margin20">
                                                                            HIV Status of partner:
                                                                        </label>
                                                                        <asp:DropDownList ID="ddlPartnerHIVStatus" runat="server">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 40%;">
                                                                        <label id="Label10" runat="server" class="required margin20">
                                                    ...
                                                    <tr id="pap1" style="display: none">
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 33%;" colspan="3" class="margin20">
                                                                    ...
                                                                    <td style="width: 34%;" class="margin20">
                                                    ...
                                                    <tr id="pap2" style="display: none">
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 33%;" class="margin20">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1FamilyHIVinformation" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label17" runat="server" Text="Family HIV information"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                            ...
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 50%;">
                                                                        ...
                                                                        <asp:RadioButton ID="rdofamilyinformationFilledYes" runat="server" GroupName="familyinformationFilled"
                                                                            Text="Yes" />
                                                                        <asp:RadioButton ID="rdofamilyinformationFilledNo" runat="server" GroupName="familyinformationFilled"
                                                                            onclick="window.open('frmFamilyInformation.aspx', '_blank');" Text="No" />
                                                                    </td>
                                                                    <td style="width: 50%;">
                            ...
                            <act:CollapsiblePanelExtender ID="CPEHTC" runat="server" SuppressPostBack="True"
                                ...
                                ImageControlID="ImgPC" BehaviorID="_content_CPEHTC">
                            </act:CollapsiblePanelExtender>
                            ...
                            <act:CollapsiblePanelExtender ID="CPEPartnerHIVStatus" runat="server" SuppressPostBack="True"
                                ...
                                CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                                BehaviorID="_content_CPEPartnerHIVStatus">
                            </act:CollapsiblePanelExtender>
                            <act:CollapsiblePanelExtender ID="CPEFamilyHIVinformation" runat="server" SuppressPostBack="True"
                                ...
                                CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                                BehaviorID="_content_CPEFamilyHIVinformation">
                            </act:CollapsiblePanelExtender>
                        </div>
                        <br />
                        <div class="border center formbg">
                    ...
                    <ContentTemplate>
                        <div class="border center formbg">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PsychosocialHistoryGBV" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label20" runat="server" Text="Psychosocial History & GBV"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1BirthandGeneralPlan" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label27" runat="server" Text="Birth and General Plan"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PreviousthreePregnanciesHistory" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label33" runat="server" Text="Previous three Pregnancies History"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <act:CollapsiblePanelExtender ID="CPEPsychosocialHistoryGBV" runat="server" SuppressPostBack="True"
                                ...
                                CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                                BehaviorID="_content_CPEPsychosocialHistoryGBV">
                            </act:CollapsiblePanelExtender>
                            <act:CollapsiblePanelExtender ID="CPEBirthandGeneralPlan" runat="server" SuppressPostBack="True"
                                ...
                                CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                                BehaviorID="_content_CPEBirthandGeneralPlan">
                            </act:CollapsiblePanelExtender>
                            <act:CollapsiblePanelExtender ID="CPEPreviousthreePregnanciesHistory" runat="server"
                                ...
                                CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                                BehaviorID="_content_CPEPreviousthreePregnanciesHistory">
                            </act:CollapsiblePanelExtender>
                        </div>
                        <br />
                        <div class="border center formbg">
                ...
                <act:TabPanel ID="TabPnlClinicalReview" runat="server" Font-Size="Large" HeaderText="Clinical Review">
                    <ContentTemplate>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PreviousObstreticsHistory" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label41" runat="server" Text="Obstretics History"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 30%;">
                                                                        <label id="Label42" runat="server" class="required margin5">
                                                                    ...
                                                                    <td style="width: 20%;">
                                                                        <label id="Label92" runat="server" align="right" class="required">
                                                                            Rhesus Factor :</label>
                                                                    ...
                                                                    <td style="width: 20%;">
                                                                        <label id="Label70" runat="server" align="right" class="required">
                                                                            Rhesus Factor :</label>
                                                                        <asp:DropDownList ID="ddlPartnerRhesusFactor" runat="server">
                                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                                            <asp:ListItem Text="Positive" Value="Positive"></asp:ListItem>
                                                                            <asp:ListItem Text="Negative" Value="Negative"></asp:ListItem>
                                                                        </asp:DropDownList>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PhysicalExaminationFindings" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label53" runat="server" Text="Physical Examination Findings"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1PresentingComplaints" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label4" runat="server" Text="Presenting Complains"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnl2PresentingComplaints" runat="server">
                                            <table width="100%" border="0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtPresentingcomplaints" TextMode="MultiLine" Width="98%" Height="100px"
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1LabGrid" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label63" runat="server" Text="Lab Orders"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1DiagnosisandPlan" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label65" runat="server" Text="Diagnosis and Plan"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                        ...
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 30%;">
                                                                        <label id="lblSpecifyWard123" runat="server" class="margin20">
                        ...
                        <act:CollapsiblePanelExtender ID="CPEPreviousObstreticsHistory" runat="server" SuppressPostBack="True"
                            ...
                            CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                            BehaviorID="_content_CPEPreviousObstreticsHistory">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPEPhysicalExaminationFindings" runat="server"
                            ...
                            CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                            BehaviorID="_content_CPEPhysicalExaminationFindings">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPELabGrid" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgPC" BehaviorID="_content_CPELabGrid">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPEDiagnosisandPlan" runat="server" SuppressPostBack="True"
                            ...
                            CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                            BehaviorID="_content_CPEDiagnosisandPlan">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPEPresentingComplaints" runat="server" SuppressPostBack="True"
                            ...
                            CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                            BehaviorID="_content_CPEPresentingComplaints">
                        </act:CollapsiblePanelExtender>
                        <br />
                        <div class="border center formbg">
                ...
                <act:TabPanel ID="TabPnlPMTCT" runat="server" Font-Size="Large" HeaderText="PMTCT">
                    <ContentTemplate>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1ManagementHIVPositiveClientOtherFacility" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label73" runat="server" Text="PMTCT Interventions"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnl2ManagementHIVPositiveClientOtherFacility" runat="server">
                                            <div id="MHPCOF" style="display: none">
                                                <table cellspacing="6" cellpadding="0" border="0" style="width: 100%; display: none">
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" style="width: 50%;">
                                                                                <label id="lblOther treatment-8888643" align="center">
                                                                                    Other treatment and Work plan:</label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="width: 50%;">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1Adherence" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label79" runat="server" Text="Adherence"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1Pwp" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label81" runat="server" Text="PwP"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 40%;">
                                                                        <label id="Label82" runat="server" class="required margin5">
                                                                            ...
                                                                            <input id="rdodisclosedHIVStatusYes" type="radio" value="Yes" runat="server" name="disclosedyourHIVstatus"
                                                                                onclick="ShowHideDiscloseStatusDetails()" />
                                                                    ...
                                                                    <td style="width: 40%;" align="left">
                                                                        <label id="lblHIVStatusDetails" runat="server" class="required">
                                                    ...
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 40%;">
                                                                        <label id="Label83" runat="server" class="margin5 required">
                                                                            Condoms Issued:
                                                                    ...
                                                                    <td style="width: 40%;">
                                                                        <label id="Label100" runat="server" class="margin5 required">
                                                                            Screened for STI:
                                                                            <input id="rdoScreenedSTIYes" type="radio" value="Yes" runat="server" name="ScreenedSTI" />
                                                                            <label for="rdoScreenedSTIYes">
                                                                                Yes</label>
                                                                            <input id="rdoScreenedSTINo" type="radio" value="No" runat="server" name="ScreenedSTI" />
                                                                            <label for="rdoScreenedSTINo">
                                                                                No</label>
                                                                        </label>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 40%;">
                                                                        <label id="Label91" runat="server" align="left">
                                                                            Vaginal Discharge:
                                                    ...
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                                    <td style="width: 40%;">
                                                                        <label id="Label93" runat="server" align="left">
                                                                            Genital Ulceration:
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1WHOStaging" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label71" runat="server" Text="WHO Staging"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="Pnl1TBScreening" runat="server" onclick="fnsetCollapseState();" CssClass="border center formbg"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label88" runat="server" Text="TB Screening"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl1TreatmentPlan" runat="server" onclick="fnsetCollapseState();"
                                            ...
                                            <h2 class="forms" align="left">
                                                ...
                                                <asp:Label ID="Label103" runat="server" Text="Appointment and Admissions"></asp:Label></h2>
                                        </asp:Panel>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnl2TreatmentPlan" runat="server">
                                            <div id="TreatP" style="display: none">
                                                <table cellspacing="6" cellpadding="0" width="100%" border="0" style="display: none">
                                                    <tr>
                                                        <td class="border pad5 whitebg" width="100%">
                                                            <table width="100%" border="0">
                                                                <tr>
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <div id="Div1" style="display: inline">
                                                                    <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                                                        <tr>
                                                                            <td class="border pad5 whitebg" width="100%">
                                                                                <asp:Button ID="btnPharmacy2" runat="server" Text="Pharmacy" Enabled="true" OnClick="btnPharmacylink_Click"
                                                                                    CssClass="btn btn-primary" Height="30px" Width="11%" Style="text-align: left;" />
                                                                                <label class="glyphicon glyphicon-open" style="margin-left: -3%; vertical-align: sub;
                                                                                    color: #fff;">
                                                                                </label>
                                                ...
                                                <table width="100%" border="0">
                                                    <tr>
                                                        ...
                                                        <td style="width: 25%;">
                                                            <label id="Label110" runat="server" class="margin5">
                                                                ...
                                                                <input id="rdoAdmittedtowardPMTCTYes" type="radio" value="Yes" runat="server" name="AdmittedtowardPMTCT"
                                                                    onclick="ShowHideSpecifyWardAdmitted()" />
                                                        ...
                                                        <td style="width: 25%;">
                                                            <label id="lblSpecifyWardAdmitted" runat="server">
                                                                Specify Ward Admitted?
                        ...
                        <act:CollapsiblePanelExtender ID="CPEManagementHIVPositiveClientOtherFacility" runat="server"
                            ...
                            CollapsedImage="~/images/arrow-up.gif" Collapsed="True" ImageControlID="ImgPC"
                            BehaviorID="_content_CPEManagementHIVPositiveClientOtherFacility">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPEAdherence" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgPC" BehaviorID="_content_CPEAdherence">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPEPwp" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgPC" BehaviorID="_content_CPEPwp">
                        </act:CollapsiblePanelExtender>
                        ...
                        <act:CollapsiblePanelExtender ID="CPETreatmentPlan" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgPC" BehaviorID="_content_CPETreatmentPlan">
                        </act:CollapsiblePanelExtender>
                        ...
                        <act:CollapsiblePanelExtender ID="CPEWHOStaging" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgPC" BehaviorID="_content_CPEWHOStaging">
                        </act:CollapsiblePanelExtender>
                        <act:CollapsiblePanelExtender ID="CPETBScreening" runat="server" SuppressPostBack="True"
                            ...
                            ImageControlID="ImgPC" BehaviorID="_content_CPETBScreening">
                        </act:CollapsiblePanelExtender>
                        <br />
                        <div class="border center formbg">
    ...
    <div>
        <asp:UpdatePanel ID="notificationPanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <act:ModalPopupExtender ID="notifyPopupExtender" CancelControlID="btnCancel" TargetControlID="btn"
