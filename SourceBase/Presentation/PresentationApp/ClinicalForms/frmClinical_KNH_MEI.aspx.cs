...
namespace PresentationApp.ClinicalForms
{
    public partial class frmClinical_KNH_MEI : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            (Master.FindControl("levelOneNavigationUserControl1").FindControl("lblheader") as Label).Text = "ANC Form";
            (Master.FindControl("levelTwoNavigationUserControl1").FindControl("lblformname") as Label).Text = "ANC Form";
        ...
        private void BindList()
        {
            ...
            if (theDS.Tables["Mst_PMTCTDecode"] != null)
            {
                ...
                theDVDecode.RowFilter = "CodeName='OIProphylaxis' and (DeleteFlag = 0 or DeleteFlag IS NULL) and SystemId in(0,1)";
                theDVDecode.Sort = "SRNo";
                if (theDVDecode.Table != null)
                {
                    theDTCode = (DataTable)theUtils.CreateTableFromDataView(theDVDecode);
                    BindManager.BindCombo(ddlOIProphylaxis, theDTCode, "Name", "Id");
                }
                ...
                //Reason CTX prescribed
                theDVDecode = new DataView(theDS.Tables["mst_decode"]);
                theDVDecode.RowFilter = "CodeName='ReasonCTXpresribed' and (DeleteFlag = 0 or DeleteFlag IS NULL) and SystemId in(0,1)";
                theDVDecode.Sort = "SRNo";
                if (theDVDecode.Table != null)
                {
                    theDTCode = (DataTable)theUtils.CreateTableFromDataView(theDVDecode);
                    BindManager.BindCombo(ddlCotrimoxazoleprescribed, theDTCode, "Name", "Id");
                }

                //Reason Fluconazole prescribed
                theDVDecode = new DataView(theDS.Tables["mst_decode"]);
                theDVDecode.RowFilter = "CodeName='FluconazolePrescribedFor' and (DeleteFlag = 0 or DeleteFlag IS NULL) and SystemId in(0,1)";
                theDVDecode.Sort = "SRNo";
                if (theDVDecode.Table != null)
                {
                    theDTCode = (DataTable)theUtils.CreateTableFromDataView(theDVDecode);
                    BindManager.BindCombo(ddlfluconazole, theDTCode, "Name", "Id");
                }

                //Partner HIV Status
                theDVDecode = new DataView(theDS.Tables["mst_decode"]);
                theDVDecode.RowFilter = "CodeName='PartnerHIVStatus' and (DeleteFlag = 0 or DeleteFlag IS NULL) and SystemId in(0,1)";
                theDVDecode.Sort = "SRNo";
                if (theDVDecode.Table != null)
                {
                    theDTCode = (DataTable)theUtils.CreateTableFromDataView(theDVDecode);
                    BindManager.BindCombo(ddlPartnerHIVStatus, theDTCode, "Name", "Id");
                }
        ...
        private void SaveCancel(String TabName)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "saveMEI" + TabName, "alert('" + TabName + " tab saved successfully.');", true);
        }
        ...
        private void GetFormData()
        {
            ...
            if (theDS.Tables[1].Rows.Count > 0)
            {
                ...
                //update KK
                if (theDS.Tables[1].Rows[0]["TreatmentPlan"] != System.DBNull.Value)
                {
                    this.UserControlKNH_Pharmacy1.ddlTreatmentplan.SelectedValue = theDS.Tables[1].Rows[0]["TreatmentPlan"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["NoOfDrugsSubstituted"] != System.DBNull.Value)
                {
                    this.UserControlKNH_Pharmacy1.txtNoofdrugssubstituted.Text = theDS.Tables[1].Rows[0]["NoOfDrugsSubstituted"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["ReasonForSwitch"] != System.DBNull.Value)
                {
                    this.UserControlKNH_Pharmacy1.ddlReasonforswitchto2ndlineregimen.SelectedValue = theDS.Tables[1].Rows[0]["ReasonForSwitch"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["OIProphylaxis"] != System.DBNull.Value)
                {
                    this.ddlOIProphylaxis.SelectedValue = theDS.Tables[1].Rows[0]["OIProphylaxis"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["CTXprescribedFor"] != System.DBNull.Value)
                {
                    this.ddlCotrimoxazoleprescribed.SelectedValue = theDS.Tables[1].Rows[0]["CTXprescribedFor"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["FluconazoleprescribedFor"] != System.DBNull.Value)
                {
                    this.ddlfluconazole.SelectedValue = theDS.Tables[1].Rows[0]["FluconazoleprescribedFor"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["OtherOIprophylaxis"] != System.DBNull.Value)
                {
                    this.txtOtherOIPropholyxis.Text = theDS.Tables[1].Rows[0]["OtherOIprophylaxis"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["OtherTreatment"] != System.DBNull.Value)
                {
                    this.txtOthertreatment.Text = theDS.Tables[1].Rows[0]["OtherTreatment"].ToString();
                }

                if (theDS.Tables[1].Rows[0]["PartnerAge"] != System.DBNull.Value)
                {
                    this.txtPartnerAge.Text = theDS.Tables[1].Rows[0]["PartnerAge"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["PartnerHIVStatus"] != System.DBNull.Value)
                {
                    this.ddlPartnerHIVStatus.SelectedValue = theDS.Tables[1].Rows[0]["PartnerHIVStatus"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["PartnerRhesusfactor"] != System.DBNull.Value)
                {
                    this.ddlPartnerRhesusFactor.SelectedValue = theDS.Tables[1].Rows[0]["PartnerRhesusfactor"].ToString();
                }
                if (theDS.Tables[1].Rows[0]["ScreenedForSTI"] != System.DBNull.Value)
                {
                    if (theDS.Tables[1].Rows[0]["ScreenedForSTI"].ToString() == "True")
                    {
                        rdoScreenedSTIYes.Checked = true;
                    }
                    if (theDS.Tables[1].Rows[0]["ScreenedForSTI"].ToString() == "False")
                    {
                        rdoScreenedSTINo.Checked = true;
                    }
                }
                if (theDS.Tables[1].Rows[0]["UrethralDischarge"] != System.DBNull.Value)
                {
                    if (theDS.Tables[1].Rows[0]["UrethralDischarge"].ToString() == "True")
                    {
                ...
                if (theDS.Tables[1].Rows[0]["vaginalDischarge"] != System.DBNull.Value)
                {
                    if (theDS.Tables[1].Rows[0]["vaginalDischarge"].ToString() == "True")
                    {
                ...
                if (theDS.Tables[1].Rows[0]["GenitalUlteration"] != System.DBNull.Value)
                {
                    if (theDS.Tables[1].Rows[0]["GenitalUlteration"].ToString() == "True")
                    {
        ...
        private void GetDataforAutopopulate()
        {
            ...
            if (theDS.Tables[4].Rows.Count > 0)
            {
                GrdPrevthreeFreq.Columns.Clear();
                BindGridPrevPreg();
                theDS.Tables[4].TableName = "dtPrevpreg";
                GrdPrevthreeFreq.DataSource = theDS.Tables[4];
                GrdPrevthreeFreq.DataBind();
                DataTable theDTGRVPrevPreg = (DataTable)GrdPrevthreeFreq.DataSource;
                ViewState["GridPrevPregData"] = theDTGRVPrevPreg;
            }
        ...
        private Boolean PMTCTTabfieldValidation()
        {
            ...
            if (!rdodisclosedHIVStatusYes.Checked && !rdodisclosedHIVStatusNo.Checked)
            {
                MsgBuilder msgBuilder = new MsgBuilder();
            ...
            if (rdodisclosedHIVStatusYes.Checked == true && GetCheckBoxListcheckedIDs(pnlHIVStatus, "HIVStatusID", "HIVStatus_Other", 0).Rows.Count == 0)
            {
                MsgBuilder msgBuilder = new MsgBuilder();
                msgBuilder.DataElements["Control"] = " -If yes disclosed HIV Status to";
                validateMessage += IQCareMsgBox.GetMessage("BlankTextBox", msgBuilder, this) + "</br>";
                validationCheck = false;
            }
        ...
        private Boolean HTCTabfieldValidation()
        {
            int i = 0;
            string validateMessage = "Following values are required:</br>";
            bool validationCheck = true;
            ...
            if (!rdoPatientaccPartnerYes.Checked && !rdoPatientaccPartnerNo.Checked)
            {
                MsgBuilder msgBuilder = new MsgBuilder();
            ...
            if (!rdoHIVTestingTodayYes.Checked && !rdoHIVTestingTodayNo.Checked)
            {
                MsgBuilder msgBuilder = new MsgBuilder();
                msgBuilder.DataElements["Control"] = " -Is client due for HIV Testing Today";
                validateMessage += IQCareMsgBox.GetMessage("BlankTextBox", msgBuilder, this) + "</br>";
                validationCheck = false;
            }
        ...
        private Boolean ClinicalReviewTabfieldValidation()
        {
            int i = 0;
            string validateMessage = "Following values are required:</br>";
            bool validationCheck = true;
            AuthenticationManager auth = new AuthenticationManager();
            if (ddlMaternalBloodGroup.SelectedValue == "0")
            {
                MsgBuilder msgBuilder = new MsgBuilder();
            ...
            if (ddlRhesusFactor.SelectedValue == "0")
            {
                MsgBuilder msgBuilder = new MsgBuilder();
        ...
        public void Authenticate()
        {
            ...
            if (Authentication.HasFunctionRight(ApplicationAccess.MEIForm, FunctionAccess.Print, (DataTable)Session["UserRight"]) == false)
            {
                btnTriageClose.Enabled = false;
                btnTriagePrint.Enabled = false;

            }
            if (Authentication.HasFunctionRight(ApplicationAccess.MEIForm, FunctionAccess.Add, (DataTable)Session["UserRight"]) == false)
            {
                btnTriageSave.Enabled = false;
                btnTriageClose.Enabled = false;
            }
            if (Authentication.HasFunctionRight(ApplicationAccess.MEIForm, FunctionAccess.Update, (DataTable)Session["UserRight"]) == false)
            {
                btnTriageSave.Enabled = false;
            ...
            {
                if (Authentication.HasFunctionRight(ApplicationAccess.MEIForm, FunctionAccess.View, (DataTable)Session["UserRight"]) == false)
                {
                ...
                else if (Authentication.HasFunctionRight(ApplicationAccess.MEIForm, FunctionAccess.Delete, (DataTable)Session["UserRight"]) == false)
                {
                    btnTriageSave.Text = "Delete";
                    btnTriageSave.Enabled = false;
                    btnHTCSave.Enabled = false;
        ...
        protected void btnHTCSave_Click(object sender, EventArgs e)
        {
            ...
            theHTHTC.Add("PartnerAge", txtPartnerAge.Text);
            theHTHTC.Add("PartnerHIVStatus", ddlPartnerHIVStatus.SelectedValue);
        ...
        private void ClinicalReviewData()
        {
            ...
            theHTClinicalReview.Add("PartnerRhesusFactor", ddlPartnerRhesusFactor.SelectedValue);
        ...
        protected void btnSavePMTCT_Click(object sender, EventArgs e)
        {
            ...
            //------------------------------------------------------------------------
            theHTPMTCT.Add("TreatmentPlan", UserControlKNH_Pharmacy1.ddlTreatmentplan.SelectedValue);
            theHTPMTCT.Add("NoOfDrugsSubstituted", UserControlKNH_Pharmacy1.txtNoofdrugssubstituted.Text);
            theHTPMTCT.Add("ReasonForSwitch", UserControlKNH_Pharmacy1.ddlReasonforswitchto2ndlineregimen.SelectedValue);
            theHTPMTCT.Add("OIProphylaxis", ddlOIProphylaxis.SelectedValue);
            theHTPMTCT.Add("CTXprescribedFor", ddlCotrimoxazoleprescribed.SelectedValue);
            theHTPMTCT.Add("FluconazoleprescribedFor", ddlfluconazole.SelectedValue);
            theHTPMTCT.Add("OtherOIprophylaxis", txtOtherOIPropholyxis.Text);
            theHTPMTCT.Add("OtherTreatment", txtOthertreatment.Text);
            //------------------------------------------------------------------------
            ...
            theHTPMTCT.Add("ScreenedForSTI", rdoScreenedSTIYes.Checked == true ? "1" : rdoScreenedSTINo.Checked == true ? "0" : "2");
            theHTPMTCT.Add("UrethralDischarge", chkUrethralDischarge.Checked == true ? "1" : chkUrethralDischarge.Checked == false ? "0" : "0");
            theHTPMTCT.Add("VaginalDischarge", chkVaginalDischarge.Checked == true ? "1" : chkVaginalDischarge.Checked == false ? "0" : "0");
            theHTPMTCT.Add("GenitalUlteration", chkGenitalUlceration.Checked == true ? "1" : chkGenitalUlceration.Checked == false ? "0" : "0");
        ...
        private void GetMultiSelectListItems(ref DataSet theDSMEI)
        {
            ...
            //ART Change code
            DataTable DTARTChangeCode = new DataTable();
            DTARTChangeCode = getCheckBoxListItemValues(UserControlKNH_Pharmacy1.chklistARTchangecode);
            DTARTChangeCode.TableName = "ARTChangeCode";
            theDSMEI.Tables.Add(DTARTChangeCode);

            //ART Change code
            DataTable DTARTStopCode = new DataTable();
            DTARTStopCode = getCheckBoxListItemValues(UserControlKNH_Pharmacy1.chklistARTstopcode);
            DTARTStopCode.TableName = "ARTStopCode";
            theDSMEI.Tables.Add(DTARTStopCode);

            //ART Change code
            DataTable EligibleThrough = new DataTable();
            EligibleThrough = getCheckBoxListItemValues(UserControlKNH_Pharmacy1.chklistEligiblethrough);
            EligibleThrough.TableName = "EligibleThrough";
            theDSMEI.Tables.Add(EligibleThrough);
