                                                            ...
                                                            <asp:Panel ID="pnlheaderpastmedicalrecord" runat="server">
                                                                <table width="100%">
                                                                    <tr align="left">
                                                                        <td>
                                                                            <h2 class="forms" align="left">
                                                                                <asp:ImageButton ID="imgpastmedicalrecord" ImageUrl="~/images/arrow-up.gif" runat="server" /> Past Medical Record
                                                                            </h2>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <asp:Panel ID="pnlheaderdrugallergies" runat="server">
                                                                <table width="100%">
                                                                    <tr align="left">
                                                                        <td>
                                                                            <h2 class="forms" align="left">
                                                                                <asp:ImageButton ID="imgdrugallergies" ImageUrl="~/images/arrow-up.gif" runat="server" /> Drug Allergies
                                                                            </h2>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <asp:Panel ID="pnlheaderarvsideeffects" runat="server">
                                                                <table width="100%">
                                                                    <tr align="left">
                                                                        <td>
                                                                            <h2 class="forms" align="left">
                                                                                <asp:ImageButton ID="imgARVSideEffects" ImageUrl="~/images/arrow-up.gif" runat="server" /> ARV Side Effects
                                                                            </h2>
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <asp:Panel ID="pnlLabEvaluationHeader" runat="server">
                                                                <table width="100%">
                                                                    <tr align="left">
                                                                        <td>
                                                                            <h2 class="forms" align="left">
                                                                                <asp:ImageButton ID="imgLabEvaluation" ImageUrl="~/images/arrow-up.gif" runat="server" /> Lab Evaluation
                                                                            </h2>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <asp:Panel ID="pnlclientsourcestatus" runat="server">
                                                                <table width="100%">
                                                                    <tr align="left">
                                                                        <td>
                                                                            <h2 class="forms" align="left">
                                                                                <asp:ImageButton ID="imgclientstatus" ImageUrl="~/images/arrow-up.gif" runat="server" /> Client and Source Patient Status
                                                                            </h2>
                                                                        </td>
                                                                    </tr>
                                                                </table>
