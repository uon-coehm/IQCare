...
<%@ Register Src="UserControl/UserControlKNH_Immunization.ascx" TagName="UserControlKNH_Immunization"
    TagPrefix="uc1" %>
<%--Nidhi--%>
...
<asp:Content ID="content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    ...
    <div style="padding-left: 8px; padding-right: 8px; padding-top: 2px;">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function rblSelectedValueDDL(val, divID, ddlControlId) {
                var selectedvalue = $("#" + val + " input:radio:checked").val();
                var YN = "";
                if (selectedvalue == "1") {
                    YN = "show";
                }
                    ...
                    document.getElementById(ddlControlId).value = 0;
                    YN = "hide";
                }
                ShowHide(divID, YN);
            }

            function MotherANC(selectId, privateFacility, gokFacility, txtprivate, txtGOK) {
                if (document.getElementById(selectId)[document.getElementById(selectId).selectedIndex].text == "Private Facility") {
                    ShowHide(privateFacility, 'show');
                    ShowHide(gokFacility, 'hide');
                    document.getElementById(txtGOK).value = "";
                }
                else if (document.getElementById(selectId)[document.getElementById(selectId).selectedIndex].text == "GOK facility") {
                    ShowHide(gokFacility, 'show');
                    ShowHide(privateFacility, 'hide');
                    document.getElementById(txtprivate).value = "";
                }
                else {
                    document.getElementById(txtprivate).value = "";
                    document.getElementById(txtGOK).value = "";
            ...
            function PlaceOfDelivery(selectId, privateFacility, gokFacility, txtprivate, txtGOK) {
                if (document.getElementById(selectId)[document.getElementById(selectId).selectedIndex].text == "Private Hospital (specify)") {
                    ShowHide(privateFacility, 'show');
                    ShowHide(gokFacility, 'hide');
                    document.getElementById(txtGOK).value = "";
                }
                else if (document.getElementById(selectId)[document.getElementById(selectId).selectedIndex].text == "GOK facility (specify)") {
                    ShowHide(gokFacility, 'show');
                    ShowHide(privateFacility, 'hide');
                    document.getElementById(txtprivate).value = "";
                }
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    <asp:TabContainer ID="tabControl" runat="server" ActiveTabIndex="0" Width="100%">
                                                                ...
                                                                <asp:Panel ID="pnlvitalsign" runat="server">
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="forms" align="left">
                                                                                    <asp:Literal ID="literalVitalSign" Text="Vital Signs" runat="server"></asp:Literal></h2>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
                                    ...
                                    <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                        <tbody>
                                            ...
                                            <tr id="tblSaveButton" align="center" valign="top">
                                                <td class="form">
                                                    <asp:Button ID="btnSaveTriage" runat="server" Text="Save" OnClick="btnSaveTriage_Click" /><asp:Button
                                                        ID="btnCloseTriage" runat="server" Text="Close" OnClick="btnCloseTriage_Click" /><asp:Button
                                                            ID="btnPrintTriage" Text="Print" OnClientClick="WindowPrint()" runat="server" />
                                                </td>
                                            </tr>
                        ...
                        <asp:TabPanel ID="TabClinicalHistory" runat="server" Font-Size="Medium" HeaderText="Clinical History">
                            <HeaderTemplate>
                                Clinical History</HeaderTemplate>
                            <ContentTemplate>
                                <div class="border center formbg">
                                    <table class="center formbg" cellspacing="6" cellpadding="0" width="100%" border="0">
                                        <div class="center formbg">
                                                            ...
                                                            <tr>
                                                                <td style="width: 50%" align="left">
                                                                    <label class="required" for="chkLTMedications">
                                                                        <asp:Label ID="lblHeadingChronic" Text="*Chronic condition:" runat="server"></asp:Label></label><div
                                                                            class="customdivbordermultiselect">
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 60%" align="left">
                                                                                        <input id="txtadmissionstart" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                            onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                            size="11" type="text"></input>
                                                                                        &nbsp;</input><img id="Img2" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                            name="appDateimg" onclick="w_displayDatePicker('<%=txtadmissionstart.ClientID%>');"
                                                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                                class="smallerlabel" id="Span2">(DD-MMM-YYYY)</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 60%" align="left">
                                                                                        <input id="txtadmissionend" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                            onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                            size="11" type="text"></input>
                                                                                        &nbsp;</input><img id="Img3" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                            name="appDateimg" onclick="w_displayDatePicker('<%=txtadmissionend.ClientID%>');"
                                                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                                class="smallerlabel" id="Span3">(DD-MMM-YYYY)</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td class="border pad6 whitebg" width="50%" align="center">
                                                                    ...
                                                                    <input id="rdomedicalhistoryyes" runat="server" name="medicalhistoryyes" onclick="down(this);"
                                                                        onfocus="up(this);" onmouseup="up(this);" type="radio"></input>
                                                                    &nbsp;</input><label>Yes</label>
                                                                    <input id="rdomedicalhistoryno" runat="server" name="medicalhistoryyes" onclick="down(this);"
                                                                        onfocus="up(this);" onmouseup="up(this);" type="radio"></input>
                                    ...
                                    <div class="center formbg">
                                        <asp:Panel ID="pnltbhistory" runat="server">
                                            <table id="Table2" class="formbg" cellspacing="6" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td class="border center pad5 whitebg" style="width: 100%">
                                                        <table width="100%">
                                                            <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                            ...
                                                                            <table width="100%" border="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 60%" align="left">
                                                                                            <input id="txtcompletetxdate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                                onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                                size="11" type="text"></input>
                                                                                            &nbsp;</input><img id="Img4" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                                name="appDateimg" onclick="w_displayDatePicker('<%=txtcompletetxdate.ClientID%>');"
                                                                                                src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                                    class="smallerlabel" id="Span4">(DD-MMM-YYYY)</span>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                    ...
                                                                    <td>
                                                                        <div id="divretreatmentdate" style="display: none;">
                                                                            ...
                                                                            <input id="txtretreatmentdate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                size="11" type="text"></input>
                                                                            &nbsp;</input><img id="Img34" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                name="appDateimg" onclick="w_displayDatePicker('<%=txtretreatmentdate.ClientID%>');"
                                                                                src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                    class="smallerlabel" id="Span34">(DD-MMM-YYYY)</span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                ...
                                                <tr>
                                                    <td align="left" class="formbg">
                                                        <h2 class="forms" align="left">
                                                            Immunisation Status</h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border pad6 whitebg" width="100%" align="center" style="display: none">
                                                        <label id="Label29">
                                                ...
                                                <tr>
                                                    <td align="center" class="border pad6 whitebg" width="100%">
                                                        <uc1:UserControlKNH_Immunization ID="UserControlKNH_Immunization1" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                                        ...
                                                        <div id="divarvexposure">
                                                            <table width="100%" class="border center whitebg" style="margin-bottom: 6px;">
                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 70%" align="right">
                                                                                        <label>
                                                                                            Did mother receive PMTCT interventions?:</label>
                                                                                    </td>
                                                                                    <td style="width: 30%" align="left">
                                                                                        <asp:RadioButtonList ID="rblMotherReceivePMTCT" runat="server" RepeatDirection="Horizontal">
                                                                    ...
                                                                    <td style="width: 50%">
                                                                        <table width="100%" id="DivPMTCTOption" style="display: none">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 50%" align="right">
                                                                                        <label>
                                                                                            Mothers PMTCT option:</label>
                                                                                    </td>
                                                                                    <td style="width: 50%" align="left">
                                                                                        <asp:DropDownList ID="ddlMotherPMTCToption" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="right" style="width: 50%">
                                                                                        <label>
                                                                                            Childs PMTCT option:</label>
                                                                                    </td>
                                                                                    <td align="left" style="width: 50%">
                                                                                        <asp:DropDownList ID="ddlChildPMTCToption" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                            ...
                                                            <table width="100%" class="border center whitebg" style="margin-bottom: 6px;">
                                                                <tr>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 40%" align="right">
                                                                                        <label>
                                                                                            Mother ANC attended :</label>
                                                                                    </td>
                                                                                    <td style="width: 60%" align="left">
                                                                                        <asp:DropDownList ID="ddlMotherANCAttended" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                    ...
                                                                    <td style="width: 50%">
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr id="trANCGOK" style="display: none">
                                                                                    <td style="width: 50%" align="right">
                                                                                        <label>
                                                                                            Specify ANC GOK facility:</label>
                                                                                    </td>
                                                                                    <td style="width: 50%" align="left">
                                                                                        <asp:TextBox ID="txtSpecifyANCGOKFacility" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="trANCPrivate" style="display: none">
                                                                                    <td align="right" style="width: 50%">
                                                                                        <label>
                                                                                            Specify ANC Private facility:</label>
                                                                                    </td>
                                                                                    <td align="left" style="width: 50%">
                                                                                        <asp:TextBox ID="txtSpecifyANCPrivateFacility" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                            ...
                                                            <table width="100%" class="border center whitebg" style="margin-bottom: 6px;">
                                                                <tr>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 60%" align="left">
                                                                                        <asp:DropDownList ID="ddlPlaceOfDelivery" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                    ...
                                                                    <td style="width: 50%">
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr id="trDeliveryGOK" style="display: none">
                                                                                    <td style="width: 50%" align="right">
                                                                                        <label>
                                                                                            Specify delivery GOK facility:</label>
                                                                                    </td>
                                                                                    <td style="width: 50%" align="left">
                                                                                        <asp:TextBox ID="txtSpecifyGOKDeliveryFacility" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr id="trDeliveryPrivate" style="display: none">
                                                                                    <td align="right" style="width: 50%">
                                                                                        <label>
                                                                                            Specify delivery Private facility:</label>
                                                                                    </td>
                                                                                    <td align="left" style="width: 50%">
                                                                                        <asp:TextBox ID="txtSpecifyPrivateDeliveryFacility" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                            ...
                                                            <table width="100%" class="border center whitebg" style="margin-bottom: 6px;">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 50%">
                                                                        <table width="100%" id="trModeOfdelivery" style="display: none">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 50%" align="right">
                                                                                        <label>
                                                                                            Specify other mode of delivery:</label>
                                                                                    </td>
                                                                                    <td style="width: 50%" align="left">
                                                                                        <asp:TextBox ID="txtSpecifyModeOfDelivery" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 40%" align="right">
                                                                                        <label>
                                                                                            Breast feeding option:</label>
                                                                                    </td>
                                                                                    <td style="width: 60%" align="left">
                                                                                        <asp:DropDownList ID="ddlBreastFeedingOption" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 40%" align="right">
                                                                                        <label>
                                                                                            Breast feeding duration:</label>
                                                                                    </td>
                                                                                    <td style="width: 60%" align="left">
                                                                                        <asp:TextBox ID="txtBreastFeedingDuration" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 60%" align="left">
                                                                                        <input id="txtpepstartdate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                            onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                            size="11" type="text"></input>
                                                                                        &nbsp;</input><img id="Img37" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                            name="appDateimg" onclick="w_displayDatePicker('<%=txtpepstartdate.ClientID%>');"
                                                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                                class="smallerlabel" id="Span37">(DD-MMM-YYYY)</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 60%" align="left">
                                                                                        <input id="txthaartstartdate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                            onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                            size="11" type="text"></input>
                                                                                        &nbsp;</input><img id="Img36" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                            name="appDateimg" onclick="w_displayDatePicker('<%=txthaartstartdate.ClientID%>');"
                                                                                            src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                                class="smallerlabel" id="Span36">(DD-MMM-YYYY)</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    ...
                                                                                    <asp:TextBox runat="server" Width="50%" ID="txtcd4"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input id="txtcd4date" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                        onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                        size="11" type="text"></input>
                                                                                    &nbsp;</input><img id="Img38" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                        name="appDateimg" onclick="w_displayDatePicker('<%=txtcd4date.ClientID%>');"
                                                                                        src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                            class="smallerlabel" id="Span38">(DD-MMM-YYYY)</span>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <input id="txthigcd4everdate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                        onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                        size="11" type="text"></input>
                                                                                    &nbsp;</input><img id="Img39" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                        name="appDateimg" onclick="w_displayDatePicker('<%=txthigcd4everdate.ClientID%>');"
                                                                                        src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                            class="smallerlabel" id="Span39">(DD-MMM-YYYY)</span>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 60%" align="left">
                                                                                    <input id="txtmostrecentcd4date" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                        onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                        size="11" type="text"></input>
                                                                                    &nbsp;</input><img id="Img41" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                        name="appDateimg" onclick="w_displayDatePicker('<%=txtmostrecentcd4date.ClientID%>');"
                                                                                        src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                            class="smallerlabel" id="Span41">(DD-MMM-YYYY)</span>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 60%" align="left">
                                                                                    <input id="txtcd4artinitdate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                        onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                        size="11" type="text"></input>
                                                                                    &nbsp;</input><img id="Img40" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                        name="appDateimg" onclick="w_displayDatePicker('<%=txtcd4artinitdate.ClientID%>');"
                                                                                        src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                            class="smallerlabel" id="Span40">(DD-MMM-YYYY)</span>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 60%" align="left">
                                                                                    <input id="txtpreviousviralloaddate" runat="server" maxlength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                                                                        onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,'3')"
                                                                                        size="11" type="text"></input>
                                                                                    &nbsp;</input><img id="Img42" alt="Date Helper" border="0" height="22 " hspace="5"
                                                                                        name="appDateimg" onclick="w_displayDatePicker('<%=txtpreviousviralloaddate.ClientID%>');"
                                                                                        src="../images/cal_icon.gif" style="vertical-align: text-bottom;" width="22" /><span
                                                                                            class="smallerlabel" id="Span42">(DD-MMM-YYYY)</span>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td class="border pad6 whitebg" width="100%" colspan="2">
                                                                    <table width="100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox runat="server" ID="txtotherhivrelated_history" Width="100%" TextMode="MultiLine"
                                                                                    Rows="3"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                ...
                                <asp:CollapsiblePanelExtender ID="cpemedicalhistory" runat="server" SuppressPostBack="True"
                                    ...
                                    Collapsed="True" ImageControlID="imgheadermedicalhistory" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                <asp:CollapsiblePanelExtender ID="cpetbhistory" runat="server" SuppressPostBack="True"
                                    ...
                                    ImageControlID="imgpnlheadertbhistory" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                <asp:CollapsiblePanelExtender ID="cpearvhistory" runat="server" SuppressPostBack="True"
                                    ...
                                    Collapsed="True" ImageControlID="imgpnlheaderarvhistory" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                <asp:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" SuppressPostBack="True"
                                    ...
                                    ImageControlID="imgHIVHistory" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                <br />
                                <div class="border center formbg">
                                    <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                        <tbody>
                                            ...
                                            <tr align="center" valign="top">
                                                <td class="form">
                                                    <asp:Button ID="btnSaveCHistory" runat="server" Text="Save" OnClick="btnSaveCHistory_Click" /><asp:Button
                                                        ID="btnCloseHistory" runat="server" Text="Close" OnClick="btnCloseHistory_Click" /><asp:Button
                                                            ID="btnPrintCHistory" Text="Print" OnClientClick="WindowPrint()" runat="server" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <asp:TabPanel ID="TabTBSCreening" runat="server" Font-Size="Medium" HeaderText="TB Screening">
                            ...
                            <ContentTemplate>
                                ...
                                <%--  <div class="border center formbg">
                                        ...
                                        </div>--%><%--  <asp:CollapsiblePanelExtender ID="cpetbscreening" runat="server" SuppressPostBack="true"
                        ...
                        <asp:TabPanel ID="TabExamination" runat="server" Font-Size="Medium" HeaderText="Examination">
                            ...
                            <ContentTemplate>
                                                                ...
                                                                <asp:Panel ID="pnlheaderlongtermmedication" runat="server">
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="forms" align="left">
                                                                                    <asp:Literal ID="literalCurrentLong" Text="Current Long Term Medications" runat="server"></asp:Literal></h2>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
                                                ...
                                                <tr>
                                                    <td class="border whitebg" style="width: 100%">
                                                        <table width="100%">
                                                            <tr>
                                                                <td style="width: 50%" align="left">
                                                                    <asp:Label ID="lblLongTermText" CssClass="required" Font-Bold="True" runat="server">*Long term medications:</asp:Label><div
                                                                        class="customdivbordermultiselect">
                                                                ...
                                                                <td style="width: 50%; display: none;" align="left" id="divLongTermMedication">
                                                                    ...
                                                                    &nbsp;<asp:TextBox ID="txOtherLongTermMedications" runat="server" Width="99%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                ...
                                                                <asp:Panel ID="pnlheaderphysicalexam" runat="server">
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="forms" align="left">
                                                                                    <asp:Literal ID="literalPhysicalExam" runat="server" Text="Physical Examination"></asp:Literal></h2>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
                                                        ...
                                                        <tr class="border pad5 whitebg">
                                                            ...
                                                            <td style="width: 50%;" align="left">
                                                                <div id="divHIV" style="display: none;">
                                                                    ...
                                                                    &nbsp;<asp:TextBox ID="txtHIVRelatedOI" runat="server" Skin="MetroTouch" Width="100%"></asp:TextBox></div>
                                                                <div style="display: none;" id="divNonHIV">
                                                                    <label id="Label4" for="txtotherchroniccondition">
                                                                        Specify Non HIV related OI:</label><br />
                                                                    &nbsp;<asp:TextBox ID="txtNonHIVRelatedOI" runat="server" Skin="MetroTouch" Width="100%"></asp:TextBox></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <asp:CollapsiblePanelExtender ID="cpedevmil" runat="server" SuppressPostBack="True"
                                    ...
                                    ImageControlID="imgdevmilestones" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                <asp:CollapsiblePanelExtender ID="CPETestandlabs" runat="server" SuppressPostBack="True"
                                    ...
                                    Collapsed="True" ImageControlID="imgtestsandlab" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                <asp:CollapsiblePanelExtender ID="CPEWhostaging" runat="server" SuppressPostBack="True"
                                    ...
                                    Collapsed="True" ImageControlID="imgwhostaging" Enabled="True">
                                </asp:CollapsiblePanelExtender>
                                ...
                                <div class="border center formbg">
                                    <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                        <tbody>
                                            ...
                                            <tr align="center" valign="top">
                                                <td class="form">
                                                    <asp:Button ID="btnSaveExam" runat="server" Text="Save" OnClick="btnSaveExam_Click" /><asp:Button
                                                        ID="btnCloseExam" runat="server" Text="Close" OnClick="btnCloseExam_Click" /><asp:Button
                                                            ID="btnPrintExam" Text="Print" OnClientClick="WindowPrint()" runat="server" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tr>
                                            <td colspan="2" align="left">
                                                <asp:Panel ID="pnlARVSideeffects" CssClass="border center formbg" runat="server"
                                                    Style="padding: 4px">
                                                    <h2 class="forms" align="left">
                                                        <asp:ImageButton ID="ImgARVSideEffect" ImageUrl="~/images/arrow-up.gif" runat="server" />ARV
                                                        Side Effects</h2>
                                                </asp:Panel>
                                            </td>
                                        </tr>
                                                                ...
                                                                <asp:Panel ID="pnlheadertreatment" runat="server">
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="forms" align="left">
                                                                                    <asp:Literal ID="literalTreatment" runat="server" Text="Treatment"></asp:Literal></h2>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
                                            ...
                                            <tr>
                                                <td colspan="2" align="left">
                                                    <asp:Panel ID="pnlOITreatment" CssClass="border center formbg" runat="server" Style="padding: 3px">
                                                        <h2 class="forms" align="left">
                                                            <asp:ImageButton ID="imgOITreatment" ImageUrl="~/images/arrow-up.gif" runat="server" />OI
                                                            Treatment</h2>
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                ...
                                <div class="border center formbg">
                                    <table cellspacing="6" cellpadding="0" width="100%" border="0">
                                        <tbody>
                                            ...
                                            <tr align="center">
                                                <td class="form">
                                                    <asp:Button ID="btnSaveManagement" runat="server" Text="Save" OnClick="btnSaveManagement_Click" /><asp:Button
                                                        ID="btnCloseManagement" runat="server" Text="Close" OnClick="btnCloseManagement_Click" /><asp:Button
                                                            ID="btnPrintManagement" Text="Print" OnClientClick="WindowPrint()" runat="server" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <asp:TabPanel ID="TabPrevwithpositive" runat="server" Font-Size="Medium" HeaderText="Prev With +ve">
                            <HeaderTemplate>
                                Prevention With Positives</HeaderTemplate>
                            <ContentTemplate>
                                <div class="border center formbg">
                                    <table class="center formbg" cellspacing="6" cellpadding="0" width="100%" border="0">
                                        <tr valign="top">
