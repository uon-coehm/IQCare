                                    ...
                                    <tr>
                                        <td class='border center pad5 whitebg' colspan="2">
                                            <table width="50%">
                                                <tr>
                                                    <td align='left'>
                                                        <asp:Label ID="lblDiagnosisAndCurrentIllness" runat="server" CssClass = "required" Font-Bold="True"
                                                        Text="Diagnosis and current illness at this visit:"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                            ...
                                            <asp:Panel ID="PnlAdherence" runat="server">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 align="left" class="forms">
                                                                <asp:Label ID="lblAdherenceHeade" runat="server" Text="Adherence"></asp:Label>
                                                                </h2>
                                                        </td>
                                                    </tr>
                                                </table>
