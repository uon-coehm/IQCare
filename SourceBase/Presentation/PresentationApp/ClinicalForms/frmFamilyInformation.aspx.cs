...
public partial class ClinicalForms_frmFamilyInformation : BasePage
{
    ...
    private void SearchFamilyInfo()
    {
        ...
        //Set the GridData session if it is null
        if (Session["GridData"] == null)
        {
            DataSet theDS1 = PatientManager.GetAllFamilyData(Convert.ToInt32(Session["PatientId"]));
            Session["GridData"] = theDS1.Tables[0];
            Session["SaveFlag"] = "Add";
            Session["Ptn_Pk"] = Convert.ToInt32(Session["PatientId"]);
        }
