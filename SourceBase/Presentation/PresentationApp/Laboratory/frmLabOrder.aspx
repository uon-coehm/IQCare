                            ...
                            <div id="div9" runat="server">
                                <td class="form" align="left" width="50%" rowspan="2">
                                    <span id="sp53" disabled="disabled">
                                        ...
                                        <input type="radio" runat="server" id="cblSerologyPos" name="rdocblSerologyHRT" value="1"
                                            onfocus="up(this)" onclick="down(this); Validate();" /><label>Pos</label>
                                        <input type="radio" runat="server" id="cblSerologyNeg" name="rdocblSerologyHRT" value="2"
                                            onfocus="up(this)" onclick="down(this); Validate()" /><label>Neg</label>
                                    </span>
                                    <span id="sp101" value="101" disabled="disabled">
                                        ...
                                        <input type="radio" runat="server" id="cblPCRResultsPos" name="rdocblSerologyPCR"
                                            value="3" onfocus="up(this)" onclick="down(this); Validate();" /><label>Pos</label>
                                        <input type="radio" runat="server" id="cblPCRResultsNeg" name="rdocblSerologyPCR"
                                            value="4" onfocus="up(this)" onclick="down(this); Validate();" /><label>Neg</label>
                                    </span>
                                </td>
                            </div>
                                ...
                                <td class="form" align="center" style="height: 20%" width="50%" id="td2">
                                    <span id="sp103" value="103" disabled="disabled">
                                        ...
                                        <input type="radio" runat="server" id="cblRPRVDRLPos" name="rdoRPRVDRL" value="1"
                                            onfocus="up(this)" onclick="down(this)" /><label>Pos</label>
                                        <input type="radio" runat="server" id="cblRPRVDRLNeg" name="rdoRPRVDRL" value="2"
                                            onfocus="up(this)" onclick="down(this)" /><label>Neg</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
