<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true" CodeBehind="frm_LabTestResults.aspx.cs" Inherits="PresentationApp.Laboratory.frm_LabTestResults" %>
<%@ Register TagPrefix="UcLabDetails" TagName="Uc1" Src="~/Laboratory/UserControl/UserControl_LabOrderDetails.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" TagPrefix="act" Namespace="AjaxControlToolkit" %>
<asp:Content ID="contentheader" ContentPlaceHolderID="ContentPlaceHeader" runat="server">
...
<asp:ScriptManager ID="LabResultsScriptManager" runat="server" EnablePageMethods="true"
                            ...
                            <table class="center formbg" cellspacing="6" cellpadding="0" width="100%" border="0">
                                <tr>
                                    <td class="form" align="center">
                                        <div class="treeview">
                                            <h1>
                                                <asp:TreeView ID="TreeViewExisForm" ForeColor="Black" runat="server" Width="100%"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 24%;" align="left">
                                                                    <telerik:RadDateTimePicker ID="txtSpecRecdt" runat="server" Skin="Office2007" Width="200px"
                                                                        ...
                                                                        <TimeView ID="TimeView1" StartTime="08:00:00" Interval="00:15:00" EndTime="20:15:00" Columns="7"
                                                                            OnClientTimeSelecting="ClientTimeSelected" CellSpacing="-1" runat="server">
                                                                        </TimeView>
                                                                        <TimePopupButton CssClass="" HoverImageUrl="" ImageUrl="" />
                                                                        <Calendar ID="Calendar1" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False"
                                                                            UseRowHeadersAsSelectors="False" runat="server">
                                                                        </Calendar>
                                                                        <DateInput ID="DateInput1" DateFormat="dd-MMM-yyyy hh:mm tt" DisplayDateFormat="dd-MMM-yyyy hh:mm tt"
                                                                            LabelWidth="64px" Width="" runat="server">
                                                                ...
                                                                <MasterTableView NoMasterRecordsText="No Records Found" DataKeyNames="ID" CellSpacing="0"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridTemplateColumn HeaderText="Other Source" FilterControlAltText="Filter TemplateColumn2 column"
                                                                            ...
                                                                            <HeaderStyle Font-Size="12px" Wrap="False" Width="15%" Font-Bold="True" />
                                                                            <ItemTemplate>
