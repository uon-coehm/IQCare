                        ...
                        <td valign="bottom">
                            <asp:Menu ID="mainMenu" runat="server" Orientation="Horizontal" CssClass="levelOneMenu"
                                ...
                                <Items>
                                    ...
                                    <asp:MenuItem NavigateUrl="~/Laboratory/frmImportLabResults.aspx" 
                                        Text="Import Lab Results" Value="Import Lab Results"></asp:MenuItem>
                                    <asp:MenuItem NavigateUrl="~/PharmacyDispense/frmPharmacyDispense_FindPatient.aspx" 
                                        Text="Dispense" Value="Dispense"></asp:MenuItem>
                                </Items>
