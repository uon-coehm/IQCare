...
<%@ Register src="../ClinicalForms/UserControl/UserControl_Alerts.ascx" tagname="UserControl_Alerts" tagprefix="uc1" %>
...
<asp:Menu ID="patientLevelMenu" runat="server" OnMenuItemClick="patientLevelMenu_MenuItemClick1" Orientation ="Horizontal" CssClass="levelTwoMenu"
    ...
    <asp:MenuItem Text="Create New Form" Selectable="False">
        ...
        <asp:MenuItem Text="Laboratory" Value="mnuLabOrderPMTCT" ></asp:MenuItem> 

        <asp:MenuItem Text="Laboratory" Value="mnuOrderLabTestPMTCT" >
        </asp:MenuItem>
...
<asp:Menu ID="PharmacyDispensingMenu" runat="server" 
    Orientation ="Horizontal" CssClass="levelTwoMenu"
                     ForeColor ="White" Width="100%" 
        RenderingMode="Table" StaticEnableDefaultPopOutImage="False" 
    ...
    <asp:MenuItem Text="Dashboard" Value="Dashboard" 
            NavigateUrl="~/PharmacyDispense/frmPharmacy_Dashboard.aspx">
         
    </asp:MenuItem>
    <asp:MenuItem Text="Dispense" Value="Dispense" 
            NavigateUrl="~/PharmacyDispense/frmPharmacyDispense_FindPatient.aspx" >
    
    </asp:MenuItem>
        <asp:MenuItem Text="Stock Summary" Value="StockSummaryWeb" 
            NavigateUrl="~/PharmacyDispense/frmPharmacy_StockSummary.aspx"></asp:MenuItem>
    <asp:MenuItem Text="Stock Management" Value="StockManagement" 
            NavigateUrl="~/PharmacyDispense/frmPharmacy_StockManagement.aspx">
    ...
    <asp:Panel ID="PanelPatiInfo" class="border center formbg" runat="server" Width="100%">
                            ...
                            <tbody>
                                <tr id="trPatientInfo" class="border">
                                    <td class="form" align="center">
                                        ...
                                        <asp:Label ID="lblAge" runat="server" Font-Bold="True"></asp:Label></label>
                                        &nbsp;&nbsp;&nbsp; <label class="bold">Gender: 
                                        <asp:Label ID="lblGender" runat="server" Font-Bold="True"></asp:Label></label>

                                        <label class="bold" style="visibility: hidden">
                                            IQ Number:
                                            <asp:Label ID="lblIQnumber" runat="server" Visible="False"></asp:Label>&nbsp; 
                                            </label>
        ...
        <%--<uc2:UserControlKNH_Extruder ID="UserControlKNH_Extruder1" 
            runat="server" />--%>
                    </div>
