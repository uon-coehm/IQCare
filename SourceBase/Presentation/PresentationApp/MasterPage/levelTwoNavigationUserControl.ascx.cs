...
public partial class MasterPage_levelTwoNavigationUserControl : System.Web.UI.UserControl
{
        ...
        foreach (DataRow theDR in dtrules.Rows)
        {
            if (Convert.ToInt32(theDR["Featureid"]) != 71)
            {
                ...
                else if (Convert.ToInt32(theDR["FeatureId"]) == 5 && Session["PaperLess"].ToString() == "1")
                {
                    ...
                    theLabTest = string.Format("{0}&sts={1}", "../Laboratory/frm_Laboratory.aspx?name=Add", lblpntStatus.Text);
                }
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); divUgandaBlueCard(); divKHNPEP(); divKHNCCC(); ClinicID();
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); divUgandaBlueCard(); divKHNPEP(); divKHNCCC(); divPMTCT();
                    LoadCreateNewMenu(theURL, rowNo);
                    if (lblpntStatus.Text != "1")
                    {
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); ClinicID(); divKHNPEP(); divKHNCCC(); divPMTCT();
                    if (lblpntStatus.Text != "1")
                    {
                        if (theLabTest != "")
                        {
                ...
                {
                    DivDynModule(); divUgandaBlueCard(); ClinicID(); divKHNPEP(); divKHNCCC(); divPMTCT();
                    if (lblpntStatus.Text != "1")
                    {
                        if (theLabTest != "")
                        {
                ...
                {
                    DivDynModule(); ClinicID(); divPMTCT(); divKHNPEP();
                ...
                {
                    DivDynModule(); ClinicID(); divPMTCT(); divKHNCCC();
                ...
                else
                {
                    ...
                    {
                        divKenyaBlueCard(); divUgandaBlueCard(); ClinicID(); divKHNPEP(); divKHNCCC(); divPMTCT();
                        LoadCreateNewMenu(theURL, rowNo);
                    }
                    else
                    {
    ...
    private void Init_Menu()
    {
        ...
        if (dtPatientInfo != null && dtPatientInfo.Rows.Count > 0)
        {
            ...
            lblAge.Text = dtPatientInfo.Rows[0]["ageinyearmonth"].ToString();
