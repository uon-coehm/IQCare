...
//        function CalculateTotalDailyDoseSyrup(valsingleDose, valFrequency, valduration, valTotDose, valSyrup, valQtyUnitDisp) {

//            var vardose = document.getElementById(valsingleDose).value; // to get value of text box
//            var selText = document.getElementById(valFrequency).options[document.getElementById(valFrequency).selectedIndex].text // to get selected text
//            var varduration = document.getElementById(valduration).value;
//            var varsyrup = document.getElementById(valSyrup).value;

//            var result = Pharmacy_frmPharmacyForm.fnGetFrequencyMultiplier(selText).value;
//            if (result != "0" && vardose != "" && valduration != "") {
//                
//                if (varsyrup == "1") {
//                    var TotalDose = (vardose * varduration * result) / valQtyUnitDisp;
//                    document.getElementById(valTotDose).value = Math.ceil(TotalDose);
//                }
//                else {
//                    var TotalDose1 = vardose * varduration * result;
//                    document.getElementById(valTotDose).value = TotalDose1;
//                }
//            }
//            else {
//                document.getElementById(valTotDose).value = "";
...
//        }
        ...
        function CalculateTotalDailyDoseSyrup(valMorning, valNoon, valEvening, valNight, valduration, valTotDose, valSyrup, valQtyUnitDisp) {

            var varMorningdose = document.getElementById(valMorning).value;
            var varNoondose = document.getElementById(valNoon).value;
            var vareveningdose = document.getElementById(valEvening).value;
            var varNightdose = document.getElementById(valNight).value;
            var varduration = document.getElementById(valduration).value;
            var varsyrup = document.getElementById(valSyrup).value;

            alert(varMorningdose + ' ' + varNoondose + ' ' + vareveningdose + ' ' + varNightdose + ' ' + (varMorningdose + varNoondose + vareveningdose + varNightdose));

            if ((varMorningdose + varNoondose + vareveningdose + varNightdose) > 0 && valduration != "") {
                if (varsyrup == "1") {
                    var TotalDose = ((varMorningdose + varNoondose + vareveningdose + varNightdose) * varduration) / valQtyUnitDisp;
                    document.getElementById(valTotDose).value = Math.ceil(TotalDose);
                }
                else {
                    var TotalDose1 = (varMorningdose + varNoondose + vareveningdose + varNightdose) * varduration;
                    document.getElementById(valTotDose).value = TotalDose1;
                }
            }
            else {
                                        ...
                                        <tr>
                                            <td style="width: 35%" align="center">
                                                <label class="right35" style="width: 5%">
                                                    Weight:</label>
                                                <asp:TextBox ID="txtWeight" MaxLength="5" runat="server" Width="80px"></asp:TextBox>Kg
                                                <label class="smalllabel" id="dtwt" runat="server" ></label>
                                            </td>
                                            <td style="width: 35%" align="center">
                                                <label class="right35" style="width: 7%">
                                                    Height:</label>
                                                <asp:TextBox ID="txtHeight" MaxLength="4" runat="server" Width="80px"></asp:TextBox>cm
                                            ...
                                            <td style="width: 30%" align="center">
                                                ...
                                                <asp:TextBox ID="txtBSA" runat="server" Width="80px" />m<sup>2</sup>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
