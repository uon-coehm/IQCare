    ...
    public partial class frmPharmacyDispense_FindPatient : System.Web.UI.Page
    {
        ...
        private void Init_Page()
        {
           ...
           (Master.FindControl("levelTwoNavigationUserControl1").FindControl("PanelPatiInfo") as Panel).Visible = false;
            ...
            //(Master.FindControl("facilityLevelBanner") as Image).Visible=false;

            //Control myControl1 = Master.FindControl("facilityBanner");
            //if (myControl1 != null)
            //{
        ...
        protected void grdPatientPrescriptions_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            thePharmacyManager.LockpatientForDispensing(patientID, 0, Session["AppUserName"].ToString(), DateTime.Now, true);
