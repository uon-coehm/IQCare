    ...
    public partial class frmPharmacy_StockManagement : System.Web.UI.Page
    {
        ...
        private void BindCombo()
        {
            try
            {
                ...
                DataTable storeSupplier = stockMgtManager.GetStoreSupplier();
                ...
                theBindManager.BindCombo(ddlSourceStore, storeSupplier, "Name", "Id");
            }
            catch (Exception err)
            {
        ...
        private DataTable CreateOpeningStockTable()
        {
            ...
            dtOS.Columns.Add("BatchNo", typeof(int));
