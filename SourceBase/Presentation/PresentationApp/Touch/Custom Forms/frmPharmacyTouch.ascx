                ...
                <ContentTemplate>
                    ...
                    <table cellpadding="10px" class="Section">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadAutoCompleteBox ID="Autoselectdrug" runat="server" Skin="MetroTouch" OnDataSourceSelect="Autoselectdrug_DataSourceSelect" Filter="Contains"
                                    Width="500px" DropDownWidth="500" OnEntryAdded="Autoselectdrug_EntryAdded" DataSourceID="objDSDrugs">
                                </telerik:RadAutoCompleteBox>

                                <asp:ObjectDataSource ID="objDSDrugs" runat="server" 
                                    TypeName="Touch.Custom_Forms.frmPharmacyTouch"
