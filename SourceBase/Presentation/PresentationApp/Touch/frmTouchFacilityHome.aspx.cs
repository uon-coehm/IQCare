...
namespace Touch
{
    ...
    public partial class frmTouchFacilityHome : TouchPageBase
    {
        ...
        {
            IReports ReportDetails = (IReports)ObjectFactory.CreateInstance("BusinessProcess.Reports.BReports, BusinessProcess.Reports");
            System.Data.DataSet dsARTUnknown = ReportDetails.GetPtnotvisitedrecentlyUnknown(Application["AppCurrentDate"].ToString(), Application["AppCurrentDate"].ToString(), Convert.ToInt32(rcbFacility.SelectedValue));
